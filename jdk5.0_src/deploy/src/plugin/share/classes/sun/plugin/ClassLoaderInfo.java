/*
 * @(#)ClassLoaderInfo.java	1.44 04/03/24
 *
...
public class ClassLoaderInfo 
{
	...
	} else
	{
	    ...
	    Trace.msgPrintln("classloaderinfo.caching", new Object[] {cli});
		...
		Trace.msgPrintln("classloaderinfo.num", new Object[]{String.valueOf(zombieLimit), victim});
