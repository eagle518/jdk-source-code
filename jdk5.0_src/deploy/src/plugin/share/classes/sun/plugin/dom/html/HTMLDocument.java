/*
 * @(#)HTMLDocument.java	1.14 03/12/19
 *
...
public class HTMLDocument extends sun.plugin.dom.core.Document 
	...
	if(result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createHTMLObject((DOMObject)result, this);
	    if(ret != null && ret instanceof org.w3c.dom.html.HTMLElement)
	...
	throw new sun.plugin.dom.exception.PluginNotSupportedException("HTMLDocument.setBody() is not supported");
    }
	...
	Object result = obj.getMember(HTMLConstants.MEMBER_IMAGES);

	if (result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createHTMLObject((DOMObject)result, this);
	    if(ret != null && ret instanceof org.w3c.dom.html.HTMLCollection)
	...
	Object result = obj.getMember(HTMLConstants.MEMBER_APPLETS);
	if (result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createHTMLObject((DOMObject)result, this);
	    if(ret != null && ret instanceof org.w3c.dom.html.HTMLCollection)
		return (org.w3c.dom.html.HTMLCollection)ret;
	...
	Object result = obj.getMember(HTMLConstants.MEMBER_LINKS);
	...
	Object result = obj.getMember(HTMLConstants.MEMBER_FORMS);
	if (result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createHTMLObject((DOMObject)result, this);
	    if(ret != null && ret instanceof org.w3c.dom.html.HTMLCollection)
		return (org.w3c.dom.html.HTMLCollection)ret;
	...
	Object result = obj.getMember(HTMLConstants.MEMBER_ARCHORS);
	if (result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createHTMLObject((DOMObject)result, this);
	    if(ret != null && ret instanceof org.w3c.dom.html.HTMLCollection)
		return (org.w3c.dom.html.HTMLCollection)ret;
	...
	Object result = obj.call(HTMLConstants.FUNC_GET_ELEMENTS_BY_NAME, new Object[]{elementName});
	if(result == null)
	    return null;

	if(result instanceof DOMObject) {		
	    Object ret = DOMObjectFactory.createHTMLObject((DOMObject)result, this);
	    if(ret != null && ret instanceof org.w3c.dom.NodeList) {
		return (org.w3c.dom.NodeList)ret;
	    }
	}
	...
	Object result = obj.call(HTMLConstants.FUNC_GET_ELEMENTS_BY_TAGNAME, new Object[]{tagname});
	if(result == null)
	    return null;
	if(result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createHTMLObject((DOMObject)result, this);
	...
	if (result == null)
	    return null;
	if(result instanceof DOMObject){
	    Object ret = DOMObjectFactory.createHTMLElement((DOMObject)result, this);
	    if(ret != null && ret instanceof org.w3c.dom.Element)
		return (org.w3c.dom.Element)ret;
	}
...
// Debug only
    private static java.util.ArrayList list = new java.util.ArrayList();
	...
	Object result = obj.getMember(HTMLConstants.MEMBER_STYLESHEETS);

	if (result == null)
	    return null;
	    
	if(result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createStyleSheetObject((DOMObject)result, this, null);
	    if(ret != null && ret instanceof org.w3c.dom.stylesheets.StyleSheetList)
		return (org.w3c.dom.stylesheets.StyleSheetList)ret;
	}
