...
public class StyleSheetList implements org.w3c.dom.stylesheets.StyleSheetList {
     ...
     */
    public StyleSheetList(DOMObject obj, org.w3c.dom.Document doc, org.w3c.dom.Node owner) {
	this.obj = obj;
	this.doc = doc;
	this.owner = owner;
    }
	...
	try {
		...
		Object ret = DOMObjectFactory.createStyleSheet((DOMObject)result, doc, owner);
