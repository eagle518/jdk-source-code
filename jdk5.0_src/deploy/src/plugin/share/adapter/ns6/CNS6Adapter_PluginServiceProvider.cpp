/*
 * @(#)CNS6Adapter_PluginServiceProvider.cpp	1.5 03/12/19
 *
...
///=--------------------------------------------------------------------------=
//
// CNS6Adapter_PluginServiceProvider.cpp by X.Lu
//
///=--------------------------------------------------------------------------=
//
// CNS6Adapter_PluginServiceProvider.cpp is Implementation of providing 
...
JD_IMPL_ISUPPORTS1(CNS6Adapter_PluginServiceProvider, IPluginServiceProvider);

//------------------------------------------------------------------------------------
// CNS6Adapter_PluginServiceProvider::CNS6Adapter_PluginServiceProvider
//------------------------------------------------------------------------------------
CNS6Adapter_PluginServiceProvider::CNS6Adapter_PluginServiceProvider(nsISupports* pProvider)
    : mService(NULL), 
      m_pPluginManager(NULL), m_pJVMManager(NULL), m_pComponentManager(NULL),
      m_pPluginManagerAdapter(NULL), m_pJVMManagerAdapter(NULL)

{
    TRACE("CNS6Adapter_PluginServiceProvider::CPluginServiceProviderAdpter");
...
// CNS6Adapter_PluginServiceProvider::~CNS6Adapter_PluginServiceProvider
//------------------------------------------------------------------------------------
CNS6Adapter_PluginServiceProvider::~CNS6Adapter_PluginServiceProvider(void)
{
    TRACE("CNS6Adapter_PluginServiceProvider::~CNS6Adapter_PluginServiceProvider");
    if (mService != NULL)
    {
...
//------------------------------------------------------------------------------------
// CNS6Adapter_PluginServiceProvider::QueryService
//------------------------------------------------------------------------------------
//
...
//
JD_METHOD
CNS6Adapter_PluginServiceProvider::QueryService(/*[in]*/ const JDCID& clsid,
					        /*[in]*/ const JDIID& iid,
				               /*[out]*/ ISupports* *result) 
{
    TRACE("CNS6Adapter_PluginServiceProvider::QueryService");
    ...
    *result = NULL;
	...
	res = mService->GetService(kCObserverServiceCID, kIObserverServiceIID, (nsISupports**)&spObserverService, NULL);
	if (NS_SUCCEEDED(res) && spObserverService)
	    *result = new CNS6Adapter_ObserverService(spObserverService);
    ...
    res = mService->GetService(requestCID, kISupportsIID, &pMozService, NULL);
...
//------------------------------------------------------------------------------------
// CNS6Adapter_PluginServiceProvider::ReleaseService
//------------------------------------------------------------------------------------
...
//
JD_METHOD
CNS6Adapter_PluginServiceProvider::ReleaseService(/*[in]*/ const JDCID& clsid, 
					          /*[in]*/ ISupports* pService)
{
    TRACE("CNS6Adapter_PluginServiceProvider::ReleaseService\n");
