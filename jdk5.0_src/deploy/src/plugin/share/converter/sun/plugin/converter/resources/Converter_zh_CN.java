 /*
  * @(#)Converter_zh_CN.java	1.36 04/06/19
  *
...
/**
 * Simplified Chinese version of Java Plug-in HTML Converter strings.
 * from
 * US English version of Java Plug-in HTML Converter strings.
 *
...
public class Converter_zh_CN extends ListResourceBundle {
	...
	{ "about_dialog.info", "Java(TM) Plug-in HTML \u8f6c\u6362\u7a0b\u5e8f v{0}" + newline +  
