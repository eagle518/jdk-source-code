/*
 * @(#)Globals_pre.java	1.98 04/01/21
 * 
...
public class Globals {
    ...
    static public boolean isImportMode() { return _isImportMode; }
    static public boolean isInstallMode() { return _isInstallMode; }
    ...
    static public boolean isSystemCache() { return _isSystemCache; }
    static public boolean isSecureMode() { return _isSecureMode; }
    static public String getCodebaseOverride() {
	return _codebaseOverride;
    }
    static public String[] getApplicationArgs() { return _applicationArgs; }
    static public URL getCodebase() { return _codebase; }

    static public void setCodebase(URL codebase) { _codebase = codebase; }
    ...
    static public void setImportMode(boolean s) { _isImportMode = s; }
    static public void setSilentMode(boolean s) { _isSilentMode = s; }
    static public void setInstallMode(boolean s) { _isInstallMode = s; }
    static public void setSystemCache(boolean s) { _isSystemCache = s; }
    static public void setSecureMode(boolean s) { _isSecureMode = s; }
    static public void setCodebaseOverride(String s) {
