/*
 * @(#)GenFiltersReverb.c	1.16 03/12/19
 *
...
void PV_ServeInterp2FilterFullBufferNewReverb16 (GM_Voice *this_voice, void *threadContext)
{
    ...
    PV_ServeInterp2FilterPartialBufferNewReverb16 (this_voice, FALSE, threadContext);
}
...
void PV_ServeStereoInterp2FilterFullBufferNewReverb16 (GM_Voice *this_voice, void *threadContext)
{
    ...
    PV_ServeStereoInterp2FilterPartialBufferNewReverb16 (this_voice, FALSE, threadContext);
}
