...
enum band_number {
  ...
  //e_band_headers,
    ...
    e_code_StackMap_N,
    e_code_StackMap_P,
    e_code_StackMap_local_N,
    e_code_StackMap_stack_N,
    e_code_StackMap_T,
    e_code_StackMap_RC,
    e_code_StackMap_uninit_P,
#endif
...
#if 0 /* Comment out predefined StackMap bands, for now. */
#define code_StackMap_N all_bands[e_code_StackMap_N]
#define code_StackMap_P all_bands[e_code_StackMap_P]
#define code_StackMap_local_N all_bands[e_code_StackMap_local_N]
#define code_StackMap_stack_N all_bands[e_code_StackMap_stack_N]
#define code_StackMap_T all_bands[e_code_StackMap_T]
#define code_StackMap_RC all_bands[e_code_StackMap_RC]
#define code_StackMap_uninit_P all_bands[e_code_StackMap_uninit_P]
#endif
