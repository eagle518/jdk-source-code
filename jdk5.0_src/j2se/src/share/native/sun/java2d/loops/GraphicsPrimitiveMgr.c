/*
 * @(#)GraphicsPrimitiveMgr.c	1.19 04/02/17
 *
     ...
     jclass XORComp, jclass AlphaComp)
{
    ...
    rgbID = (*env)->GetFieldID(env, SG2D, "rgb", "I");
...
JNIEXPORT jint JNICALL
GrPrim_Sg2dGetRGB(JNIEnv *env, jobject sg2d)
{
    return (*env)->GetIntField(env, sg2d, rgbID);
}
