/*
 * @(#)DigestMD5Base.java	1.32 04/02/03
 *
...
abstract class DigestMD5Base extends AbstractSaslImpl {
	...
	for (int j = 0; j < providers.length; j++) {		
		...
		logger.log(Level.FINE, "DIGEST01:Platform supports 3des");
		ciphers[DES3] |= CIPHER_MASKS[DES3]; 
	    }
	    if (set.contains(JCE_CIPHER_NAME[DES])) {
		logger.log(Level.FINE, "DIGEST02:Platform supports des");
		ciphers[DES] |= CIPHER_MASKS[DES]; 
	    }
