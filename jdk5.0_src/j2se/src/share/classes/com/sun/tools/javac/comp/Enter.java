 ...
 */
public class Enter extends Tree.Visitor {
 ...
 *************************************************************************/
     ...
     */
    public Env<AttrContext> classEnv(ClassDef tree, Env<AttrContext> env) {
     ...
     */
    Env<AttrContext> topLevelEnv(TopLevel tree) {
 ...
 *************************************************************************/
	...
	boolean isPkgInfo = endsWith(""+tree.sourcefile, "package-info.java");
	if (tree.pid != null) {
	...
	List<Type> r = classEnter(tree.defs, env);
        if (addEnv) {
            todo.append(env);
        }
	log.useSource(prev);
...
//	System.err.println("entering " + c.fullname + " in " + c.owner);//DEBUG
     ...
     */
    public void complete(List<Tree> trees, ClassSymbol c) {
        annotate.enterStart();
