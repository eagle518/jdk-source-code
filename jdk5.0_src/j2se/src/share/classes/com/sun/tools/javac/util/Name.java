...
//	    System.err.println("doubling name buffer of length " + names.length + " to fit " + len + " chars");//DEBUG
	...
	private static List<SoftReference<Table>> freelist = List.make();
	...
	protected static final Context.Key<Table> namesKey =
