/*
 * @(#)VirtualMachineImpl.java	1.88 04/05/05
 *
...
class VirtualMachineImpl extends MirrorImpl
	...
	threadGroupForJDI = new ThreadGroup(vmManager.mainGroupForJDI(),
         ...
         */
        EventRequestManager tmpReqMgr = new EventRequestManagerImpl(this);
        EventRequest er = tmpReqMgr.createClassPrepareRequest();
        er.setSuspendPolicy(EventRequest.SUSPEND_NONE);
        er.enable();
        er = tmpReqMgr.createClassUnloadRequest();
        er.setSuspendPolicy(EventRequest.SUSPEND_NONE);
        er.enable();
   ...
   "verifier detected internal inconsistency or security problem");
    ...
    public String description() {
        String[] versionParts = {"" + vmManager.majorInterfaceVersion(),
