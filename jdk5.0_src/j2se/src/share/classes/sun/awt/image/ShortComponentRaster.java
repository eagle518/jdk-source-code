/*
 * @(#)ShortComponentRaster.java	1.46 03/12/19
 *
...
public class ShortComponentRaster extends SunWritableRaster {
	...
	DataBufferUShort dbs = (DataBufferUShort)dataBuffer;
	this.data = dbs.getData();
        if (dbs.getNumBanks() != 1) {
            throw new
                RasterFormatException("DataBuffer for ShortComponentRasters"+
                                      " must only have 1 bank.");
        }
        int dbOffset = dbs.getOffset();
