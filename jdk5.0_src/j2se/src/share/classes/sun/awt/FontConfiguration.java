/*
 * @(#)FontConfiguration.java	1.23 04/02/13
 *
...
public abstract class FontConfiguration {
    ...
    */
    ...
    private FontDescriptor[] buildFontDescriptors(int fontIndex, int styleIndex) {
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            CharToByteConverter converter
                    = getFontCharset(encoding.trim(), awtFontName);

            // we already have the exclusion ranges
            int[] exclusionRanges = fontExclusionRanges[i];
 
            // create descriptor
            descriptors[i] = new FontDescriptor(awtFontName, converter, exclusionRanges);
        }
        return descriptors;
    }
    ...
    private CharToByteConverter getFontCharset(final String charsetName,
            String fontName) {

	CharToByteConverter fc = null;
    ...
    protected abstract CharToByteConverter getDefaultFontCharset(
            String fontName);
