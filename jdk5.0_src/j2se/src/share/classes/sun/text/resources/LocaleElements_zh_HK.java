/*
 * @(#)LocaleElements_zh_HK.java	1.9 03/12/19
 */
...
public class LocaleElements_zh_HK extends ListResourceBundle {
    ...
    // reparent to zh_TW for traditional Chinese names and collation sequence
    public LocaleElements_zh_HK() {
        ResourceBundle bundle = LocaleData.getLocaleElements(Locale.TAIWAN);
        setParent(bundle);
    }
