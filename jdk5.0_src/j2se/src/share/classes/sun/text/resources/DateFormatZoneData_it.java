/*
 * @(#)DateFormatZoneData_it.java	1.32 04/01/20
 */
...
public final class DateFormatZoneData_it extends DateFormatZoneData
{
	...
	return new Object[][] {
	    ...
	    {"Asia/Chongqing", CTT},
	    {"Asia/Chungking", CTT},
	    {"Asia/Colombo", new String[] {"Ora dello Sri Lanka", "LKT", "Ora estiva dello Sri Lanka", "LKST"}},
	    {"Asia/Dacca", BDT},
	    {"Asia/Dhaka", BDT},
	    {"Asia/Dili", new String[] {"Ora di Timor Est", "TPT", "Ora estiva di Timor Est", "TPST"}},
	    {"Asia/Damascus", EET},
	    {"Asia/Dubai", GST},
	    ...
	    {"Pacific/Rarotonga", new String[] {"Ora delle Isole Cook", "CKT", "Ora estiva delle Isole Cook", "CKST"}},
	    {"Pacific/Saipan", ChST},
	    {"Pacific/Samoa", SAMOA},
