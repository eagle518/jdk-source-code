/*
 * @(#)DateFormatZoneData_es.java	1.31 04/01/20
 */
...
public final class DateFormatZoneData_es extends DateFormatZoneData
{
	...
	String DUBLIN[] = new String[] {"Hora de Greenwich", "GMT",
	...
	String GMTBST[] = new String[] {"Hora de Greenwich", "GMT",
	...
	return new Object[][] {
	    ...
	    {"Asia/Chongqing", CTT},
	    {"Asia/Chungking", CTT},
	    {"Asia/Colombo", new String[] {"Hora de Sri Lanka", "LKT", "Hora de verano de Sri Lanka", "LKST"}},
	    {"Asia/Dacca", BDT},
	    {"Asia/Dhaka", BDT},
	    {"Asia/Dili", new String[] {"Hora de Timor Oriental", "TPT", "Hora de verano de Timor Oriental", "TPST"}},
	    {"Asia/Damascus", EET},
	    {"Asia/Dubai", GST},
	    ...
	    {"Pacific/Rarotonga", new String[] {"Hora de las islas Cook", "CKT", "Hora de verano de las islas Cook", "CKST"}},
	    {"Pacific/Saipan", ChST},
	    {"Pacific/Samoa", SAMOA},
