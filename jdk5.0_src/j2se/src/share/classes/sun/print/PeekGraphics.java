/*
 * @(#)PeekGraphics.java	1.29 04/05/05
 *
...
public class PeekGraphics extends Graphics2D
	...
	// Need to do something here like copy the delegated config
	// and then stamp it as a pritner config. For now we delegate
	// but that's wrong.
...
/* The Delegated Graphics Methods */
   ...
   public void drawPolyline(int xPoints[], int yPoints[],
	...
	drawTextLayout(
		new TextLayout(iterator, getFontRenderContext()), x, y);
    }
...
//	}	
	...
	/* Map this call to the TextLayout draw as we can
	 * ask the TextLayout for its bounds.
	 */
	drawTextLayout(
		new TextLayout(str, getFont(), getFontRenderContext()), x, y);
    }
	...
	mPrintMetrics.drawText(this);
        ...
        // package private
    void drawTextLayout(TextLayout text, float x, float y) {

	addDrawingRect(text.getBounds(), x, y);
	mPrintMetrics.drawText(this, text);
