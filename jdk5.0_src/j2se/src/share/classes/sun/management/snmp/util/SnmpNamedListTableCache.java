/*
 * @(#)file      SnmpNamedListTableCache.java
...
public abstract class SnmpNamedListTableCache extends SnmpListTableCache {
     ...
     *
     **/
    protected          List   getRawDatas(Map userData, String key) {
	List rawDatas = null;
	...
	final Map userData = (context instanceof Map)?(Map)context:null;
