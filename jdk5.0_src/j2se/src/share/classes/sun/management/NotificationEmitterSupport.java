/*
 * @(#)NotificationEmitterSupport.java	1.3 04/04/18
 *
...
abstract class NotificationEmitterSupport 
        extends MXBeanSupport implements NotificationEmitter {

    protected NotificationEmitterSupport(Class mxbeanInterface) {
        super(mxbeanInterface, true);
    }
