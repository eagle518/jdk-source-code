/*
 * @(#)MessageToken.java	1.15 04/04/27
 *
...
abstract class MessageToken extends Krb5Token {
    ...
    private static final int FILLER = 0xffff;
     ...
     /* Use a HMAC SHA1 DES3 -KD checksum. (draft-raeburn-cat-gssapi-krb5-3des-00) */
	...
	if (existingHeader != null) {
	 ...
	 return cipherHelper.calculateChecksum(tokenHeader.getSignAlg(),
	     checksumDataHeader, optionalTrailer, data, offset, len);
    }
	...
	*/
	...
	this.cipherHelper = context.getCipherHelper();
...
*/
     ...
     * @throws GSSException if qop is incompatible with the negotiated session key
     */
