/*
 * @(#)ReverseBuilder.java	1.15 03/12/19
 *
...
class ReverseBuilder extends Builder {
	...
	targetCertSelector = (X509CertSelector) 
    ...
    /**
     * Retrieves all certs from a CertStore which satisfy the
     ...
     */
    Collection<X509Certificate> getMatchingCerts(State currState) 
	 ...
	 */
	Collection<X509Certificate> certs = getMatchingEECerts(currentState);
