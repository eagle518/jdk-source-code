/*
 * @(#)ReverseState.java	1.11 03/12/19
 *
...
class ReverseState implements State {
	...
	X509Certificate trustedCert = anchor.getTrustedCert();
	    ...
	    X500Principal caName = CertPathHelper.getCA(anchor);
	...
	subjKeyId = icert.getSubjectKeyIdentifierExtension();
 	...
 	/* update crlSign */
 	crlSign = crlChecker.certCanSignCrl(cert);
	...
	try {
	    ...
	    clonedState.userCheckers = (ArrayList) userCheckers.clone();
	    ListIterator li = clonedState.userCheckers.listIterator();
	    while (li.hasNext()) {
