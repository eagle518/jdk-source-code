...
public final class GlyphLayout {
    ...
    public static interface LayoutEngine {
        ...
        public void layout(FontStrikeDesc sd, float[] mat, int gmask, 
                           int baseIndex, TextRecord text, boolean rtl, Point2D.Float pt, GVData data);
    }
    ...
    private static final class SDCache {
        ...
        private SDCache(Font font, FontRenderContext frc) {
            ...
            sd = new FontStrikeDesc(dtx, gtx, font.getStyle(), 
                                    frc.isAntiAliased(), 
            ...
            public boolean equals(Object o) {
                try {
                    ...
                    return hash == rhs.hash &&
                        (font == rhs.font || font.equals(rhs.font)) &&
                        (frc == rhs.frc || frc.equals(rhs.frc));
                }
                catch (ClassCastException e) {
                }
                return false;
        ...
        public static SDCache get(Font font, FontRenderContext frc) {
            ...
            SDCache res = (SDCache)cache.get(key);
            if (res == null) {
    ...
    private final class EngineRecord {
        ...
        void layout() {
            ...
            engine.layout(_sd, _mat, gmask, start - _offset, _textRecord, _rtl, _pt, _gvdata);
        }
    }
}
