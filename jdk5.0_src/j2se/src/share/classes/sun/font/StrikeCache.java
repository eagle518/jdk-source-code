...
public final class StrikeCache {
     ...
     * arr[6] = offset of topLeftX
     * arr[7] = offset of topLeftY
     * arr[8] = offset of pixel data.
     * arr[9] = address of a GlyphImageRef representing the invisible glyph
     */
    static native void getGlyphCacheDescription(long[] infoArray);

    static {

	long[] nativeInfo = new long[10];
	...
	topLeftXOffset    = (int)nativeInfo[6];
	topLeftYOffset    = (int)nativeInfo[7];
	pixelDataOffset   = (int)nativeInfo[8];
	invisibleGlyphPtr = nativeInfo[9];
