...
// 		}
	...
	try {
	    ...
	    char[] substChars = { 0 };
	    converter.setSubstitutionChars(substChars);
	    ...
	    converter.convert(inputBytes, 0, inputBytes.length,
...
// 	    System.err.println("dbegin="+dBegin);
	...
	if (subtableFormat < 8) {
	    ...
	    subtableLength = buffer.getInt(offset+2) & INTMASK;
	}
...
*/
	...
	char getGlyph(int charCode) {
	    ...
	    //System.err.println( "cc="+charCode);
	    if (startCount[rangeShift] <= charCode) {
		index = rangeShift;
	    }
