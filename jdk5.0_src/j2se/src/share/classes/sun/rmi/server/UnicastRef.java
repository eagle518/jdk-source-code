...
public class UnicastRef implements RemoteRef {
	...
	Boolean tmp = (Boolean)java.security.AccessController.doPrivileged(
	    new sun.security.action.GetBooleanAction("sun.rmi.client.logCalls"));
	boolean logCalls = tmp.booleanValue();
	clientCallLog = Log.getLog("sun.rmi.client.call", "RMI", logCalls);
    }
