...
public interface SSLSession
{
    ...
    /** 
     * Gets the size of the largest SSL/TLS packet that may occur
    ...
    /** 
     * Gets the size of the largest application buffer
     * that may occur when using this session.
     * <P>
     ...
     *
     * @return  the maximum application packet size
     *
     * @see SSLEngine#wrap(ByteBuffer, ByteBuffer)
     * @see SSLEngine#unwrap(ByteBuffer, ByteBuffer)
     *
