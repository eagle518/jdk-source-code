...
public class WToolkit extends SunToolkit implements Runnable {
    ...
    protected Object lazilyLoadDesktopProperty(String name) {
        ...
        } else if (ThemeReader.isXPThemeResources(name)) {
            return ThemeReader.loadResources(name);    
	...
	public void modalityPushed(ModalityEvent ev) {
		...
		((ModalityListener)enum_.nextElement()).modalityPushed(ev);
	    }
	}
	...
	public void modalityPopped(ModalityEvent ev) {
	    Enumeration enum_ = listeners.elements();
	    while (enum_.hasMoreElements()) {
		((ModalityListener)enum_.nextElement()).modalityPopped(ev);
	    }
	}
    }
