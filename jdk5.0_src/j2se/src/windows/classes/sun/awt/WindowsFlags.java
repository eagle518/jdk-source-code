/*
 * @(#)WindowsFlags.java	1.6 03/07/18
 *
...
public class WindowsFlags {
	    ...
	    new java.security.PrivilegedAction()
	{
		...
		translAccelEnabled = getBooleanProp("sun.java2d.translaccel", 
		    false);
		...
		checkRegistry = getBooleanProp("sun.java2d.checkRegistry", false);
		disableRegistry = getBooleanProp("sun.java2d.disableRegistry", false);
