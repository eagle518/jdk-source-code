...
public:
    ...
    /* sun.io.CharToByteConverter fontCharset field of sun.awt.FontDescriptor*/
    static jfieldID fontCharsetID;
...
private:
    ...
    int m_overhang;
    /* JNI WeakGlobalRef to java.awt.Font object */
    jweak m_javaFont;
