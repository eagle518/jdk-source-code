/*
 * @(#)awt_DataTransferer.c	1.21 03/12/19
 *
...
void awt_initialize_DataTransferer() {
     ...
     * If the requestor is another JVM, it hangs as SelectionNotify is never
     * sent and we set Xt selection timeout to the maximum possible value.
