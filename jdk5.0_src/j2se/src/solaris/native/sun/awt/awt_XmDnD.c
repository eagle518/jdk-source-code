...
#include "sun_awt_motif_AWTLockAccess.h"
...
JNIEXPORT void JNICALL 
Java_sun_awt_motif_AWTLockAccess_awtLock(JNIEnv *env, jclass clazz) {
    AWT_LOCK();
}
...
JNIEXPORT void JNICALL 
Java_sun_awt_motif_AWTLockAccess_awtUnlock(JNIEnv *env, jclass clazz) {
    AWT_NOTIFY_ALL();
    AWT_UNLOCK();
}
...
JNIEXPORT void JNICALL 
Java_sun_awt_motif_AWTLockAccess_awtWait(JNIEnv *env, jclass clazz,
                                         jlong timeout) {
    AWT_WAIT(timeout);
}
...
JNIEXPORT void JNICALL 
Java_sun_awt_motif_AWTLockAccess_awtNotifyAll(JNIEnv *env, jclass clazz) {
    AWT_NOTIFY_ALL();
}
