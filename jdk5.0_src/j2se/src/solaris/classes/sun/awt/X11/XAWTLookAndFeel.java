/*
 * @(#)XAWTLookAndFeel.java	1.7 04/06/02
 *
 ...
 /**
    ...
    "inactiveCaptionBorder", "#AEB2C3", /* Border color for inactive caption (title bar) window borders. */
       ...
       "controlLightShadow", "#9397A5", /* Shadow color for controls */           
        ...
        ColorUIResource controlDarker =  new ColorUIResource(SystemColor.controlDkShadow);//new ColorUIResource(147, 151, 165);  // slate blue
        //ColorUIResource scrollBarTrack = new ColorUIResource(SystemColor.controlShadow);//controlDarker;
        
        Color back = table.getColor("control");
        Color scrollBarTrack = new Color((int) (back.getRed() * 0.85),
                            (int) (back.getGreen() * 0.85),
                            (int) (back.getBlue() * 0.85));
