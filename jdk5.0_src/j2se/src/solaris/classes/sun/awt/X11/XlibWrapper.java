/*
 * @(#)XlibWrapper.java	1.40 04/01/29
 *
...
class XlibWrapper implements XConstants, XUtilConstants, XProtocolConstants,
...
*/
    ...
    static native long XInternAtom(long display, long atom_name, int only_if_exists );
    ...
    static native void XChangeProperty(long display, long window, long atom,
...
*/
    ...
    static native void XCreateFontCursor(long display, long type);
