/*
 * @(#)MotifDnDDragSourceProtocol.java	1.5 04/01/08
 *
...
class MotifDnDDragSourceProtocol extends XDragSourceProtocol 
    ...
    public boolean attachTargetWindow(long window, long time) {
		...
		case MotifDnDConstants.MOTIF_PREFER_RECEIVER_STYLE :
                    ...
                    setTargetProxyWindow(proxy);
                    setTargetProtocolVersion(protocolVersion);
