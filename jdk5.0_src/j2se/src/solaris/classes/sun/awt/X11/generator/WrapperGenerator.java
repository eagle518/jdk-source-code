/*
 * @(#)WrapperGenerator.java	1.24 03/12/19
 *
...
public class WrapperGenerator {
    ...
    static {
/*
        knownSizes64.put("", new Integer());
        knownSizes32.put("", new Integer());
*/
        knownSizes64.put("XComposeStatus", new Integer(16));
        knownSizes64.put("XTimeCoord", new Integer(16));
        knownSizes64.put("XExtData", new Integer(32));
        knownSizes64.put("XWindowChanges", new Integer(40));
        knownSizes64.put("XOMCharSetList", new Integer(16));
        knownSizes64.put("XModifierKeymap", new Integer(16));
        knownSizes32.put("XIMValuesList", new Integer(8));
        knownSizes32.put("XGCValues", new Integer(92));
//          knownSizes32.put("XIMStringConversionCallbackStruct", new Integer(16));
    }
...
//                                                   new Object[] {getNativeAccessForType(TYPE_PTR), offset});
                      ...
                      res = MessageFormat.format("Native.get{0}({1})", 
                                                 new Object[] {getNativeAccessForType(((AtomicType)referencedType).type), 
                                                               base + "+" + offset});
//                        res = MessageFormat.format("Native.get{1}({0})", new Object[] {offset, getNativeAccessForType(((AtomicType)referencedType).type)});
//                        res = MessageFormat.format("Native.get{2}(Native.get{0}(pData+{1}))",
//                                                   new Object[] {getNativeAccessForType(TYPE_PTR), offset, 
//                                                                 getNativeAccessForType(((AtomicType)referencedType).type)});
                  }
                  break;
              case TYPE_ARRAY:
                  if (referencedType instanceof StructType) {
        ...
        String getJavaResultConversion(String value, String base) {
            if (referencedType != null) {
                if (referencedType instanceof StructType) {
                    ...
                    return value; //"unsafe.get" + ((AtomicType)referencedType).getJavaAccess(wide) + "(" + value + ")";
                }
            } else {
...
//              System.out.println("Struct " + name + " extends " + baseClass + " implements " + interfaces);
        ...
        public String getOffset(AtomicType atp) {
            String key = getName()+"."+atp.getName();
    ...
    public void writeFunctionCallWrapper(String outputDir, FunctionType ft) {
        try {
            ...
            pw.println("\t\tsynchronized(XToolkit.getAWTLock()) {");
