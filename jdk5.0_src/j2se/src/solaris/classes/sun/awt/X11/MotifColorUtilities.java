/*
 * @(#)MotifColorUtilities.java	1.6 04/01/08
 *
...
class MotifColorUtilities {
   ...
   static void loadSystemColorsForCDE(int[] systemColors) throws Exception  {
    ...
    static void loadMotifDefaultColors(int[] systemColors) {
        systemColors[SystemColor.WINDOW] = MotifColorUtilities.DEFAULT_COLOR;
        systemColors[SystemColor.TEXT] = MotifColorUtilities.DEFAULT_COLOR;
        ...
        systemColors[SystemColor.CONTROL] = MotifColorUtilities.DEFAULT_COLOR;
    ...
    static void loadSystemColors(int[] systemColors) {
        if (System.getProperty("os.name").equals("Linux")) { // Load motif default colors on Linux.
