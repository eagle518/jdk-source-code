/*
 * @(#)X11SurfaceData.java	1.52 04/02/17
 *
...
public abstract class X11SurfaceData extends SurfaceData {
             ...
             sg2d.compositeState == sg2d.COMP_XOR))
	{
		...
		if (sg2d.textAntialiasHint != SunHints.INTVAL_TEXT_ANTIALIAS_ON) {
		    // Use X11 pipe even if DGA is available since although
		    // DGA text everything slows down when mixed with X11 calls
	...
	if (x11pipe == null) {
	    x11pipe = X11Renderer.getInstance(this);
	...
	public SurfaceData getReplacement() {
	    // REMIND: X11 surfaces should never lose their contents,
