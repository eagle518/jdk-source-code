...
#pragma ident "@(#)nativeInst_sparc.hpp	1.80 04/03/17 14:08:07 JVM"
#endif
/*
...
public:
  friend NativeFarCall* nativeFarCall_at(address instr) { return (NativeFarCall*)nativeCall_at(instr); }
...
class NativeFarCall: public NativeInstruction {
 public:
  ...
  // Creation
  friend NativeFarCall* nativeFarCall_at(address instr) {
