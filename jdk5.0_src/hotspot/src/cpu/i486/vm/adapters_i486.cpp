...
#pragma ident "@(#)adapters_i486.cpp	1.17 03/12/23 16:35:59 JVM"
#endif
/*
...
#include "incls/_adapters_i486.cpp.incl"
...
int vframeArray::i2c_frame_adjust( int callee_parameters, int callee_locals ) {
  // Need size of I2C adapter to pop.  The I2C's sp starts where the de-opting
  // frame ends, at array->sp()+array->frame_size().  The I2C's frame ends at
  // the next frame's sp, adapter_caller().  Compute I2C's framesize as the diff.
