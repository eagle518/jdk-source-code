...
#pragma ident "@(#)frame_i486.inline.hpp	1.55 03/12/23 16:36:16 JVM"
#endif
/*
...
#undef EAX_NAME
#ifdef COMPILER1
#define EAX_NAME (VMReg::Name(eax->encoding()))
#endif /* COMPILER1 */
#ifdef COMPILER2
#define EAX_NAME (VMReg::Name(EAX_num))
#endif /* COMPILER2 */

inline oop frame::saved_oop_result(RegisterMap* map) const       { 
  return *((oop*) map->location(EAX_NAME));
}

inline void frame::set_saved_oop_result(RegisterMap* map, oop obj) {
  *((oop*) map->location(EAX_NAME)) = obj;
}
