...
#pragma ident "@(#)regalloc.cpp	1.19 04/03/26 14:51:47 JVM"
#endif
/*
...
OptoReg::Name PhaseRegAlloc::offset2reg(int stk_offset) const {
  ...
  int reg = (slot < (int) _framesize) 
    ...
    : slot + SharedInfo::stack0 - _framesize;
