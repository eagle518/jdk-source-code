...
#pragma ident "@(#)memoryManager.hpp	1.8 04/04/19 12:48:42 JVM"
#endif
//
...
public:
  ...
  static GCMemoryManager* get_train_memory_manager();
...
class TrainMemoryManager : public GCMemoryManager {
private:
public:
  TrainMemoryManager() : GCMemoryManager() {}
  MemoryManager::Name kind() { return MemoryManager::Train; }
  const char* name()         { return "Train"; }
