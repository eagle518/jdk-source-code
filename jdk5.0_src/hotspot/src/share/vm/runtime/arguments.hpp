...
#pragma ident "@(#)arguments.hpp	1.79 04/07/05 14:55:26 JVM"
#endif
/*
...
class Arguments : AllStatic {
 ...
 private:  
  ...
  static void add_init_library(const char* name, char* options)
    { _libraryList.add(new AgentLibrary(name, options, false)); }

  // -Xagentlib and -Xagentpath arguments
  ...
  static bool parse_argument(const char* arg);
  static bool process_argument(const char* arg, bool ignore_unrecognized);
  ...
  static jint parse_each_vm_init_arg(const JavaVMInitArgs* args, SysClassPath* scp_p, bool* scp_assembly_required_p);
  ...
  static void build_string(char** bldstr, const char* arg);
 ...
 public:
  ...
  //System properties
  static void Arguments::init_system_properties();
