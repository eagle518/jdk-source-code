...
#pragma ident "@(#)perfData.hpp	1.16 04/02/09 20:25:07 JVM"
#endif
/*
...
class PerfDataManager : AllStatic {
  ...
  public:
    ...
    static PerfStringVariable* create_string_variable(CounterNS ns,
                                                      const char* name,
                                                      const char *s, TRAPS) {
      return create_string_variable(ns, name, 0, s, CHECK_0);
    };
    ...
    static PerfLongVariable* create_long_variable(CounterNS ns,
      ...
      return create_long_variable(ns, name, u, (jlong)0, CHECK_0);
    };
    ...
    static PerfLongCounter* create_long_counter(CounterNS ns, const char* name,
                                                PerfData::Units u, TRAPS) {
      return create_long_counter(ns, name, u, (jlong)0, CHECK_0);
    };
    ...
    static PerfConstant* create_constant(CounterNS ns, const char* name,
      ...
      return create_long_constant(ns, name, u, val, CHECK_0);
    }

    static PerfVariable* create_variable(CounterNS ns, const char* name,
                                         PerfData::Units u, jlong ival, TRAPS) {
      return create_long_variable(ns, name, u, ival, CHECK_0);
    }
    ...
    static PerfVariable* create_variable(CounterNS ns, const char* name,
      ...
      return create_long_variable(ns, name, u, sp, CHECK_0);
    }

    static PerfVariable* create_variable(CounterNS ns, const char* name,
                                         PerfData::Units u,
                                         PerfSampleHelper* sh, TRAPS) {
      return create_long_variable(ns, name, u, sh, CHECK_0);
    }

    static PerfCounter* create_counter(CounterNS ns, const char* name,
                                       PerfData::Units u, jlong ival, TRAPS) {
      return create_long_counter(ns, name, u, ival, CHECK_0);
    }
    ...
    static PerfCounter* create_counter(CounterNS ns, const char* name,
                                       PerfData::Units u, jlong* sp, TRAPS) {
      return create_long_counter(ns, name, u, sp, CHECK_0);
    }

    static PerfCounter* create_counter(CounterNS ns, const char* name,
                                       PerfData::Units u,
                                       PerfSampleHelper* sh, TRAPS) {
      return create_long_counter(ns, name, u, sh, CHECK_0);
    }
