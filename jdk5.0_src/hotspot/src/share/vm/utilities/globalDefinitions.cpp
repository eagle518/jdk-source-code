...
#pragma ident "@(#)globalDefinitions.cpp	1.38 03/12/23 16:44:44 JVM"
#endif
/*
...
void check_basic_types() {
#ifdef ASSERT
#ifdef _LP64
  assert(min_intx ==  CONST64(0x8000000000000000), "correct constant");
...
#else
  assert(min_intx ==  0x80000000,  "correct constant");
  ...
  assert(HeapWordSize >= sizeof(juint),
