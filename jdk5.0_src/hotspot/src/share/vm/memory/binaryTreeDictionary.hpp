...
#pragma ident "@(#)binaryTreeDictionary.hpp	1.17 03/12/23 16:40:52 JVM"
#endif
/*
...
class TreeList: public FreeList {
 ...
 protected:
  ...
  // removeChunk() removes the given "tc" from the TreeList.
  // If "tc" is the first chunk in the list, it is also the
  // TreeList that is the node in the tree.  removeChunk()
...
class TreeChunk : public FreeChunk {
 ...
 public:
  ...
  // debugging
  void verifyTreeChunkList() const PRODUCT_RETURN;
};
...
class BinaryTreeDictionary: public FreeBlockDictionary {
 ...
 public:
  ...
  bool verifyChunkInFreeLists(FreeChunk* tc) const PRODUCT_RETURN0;
 private:
