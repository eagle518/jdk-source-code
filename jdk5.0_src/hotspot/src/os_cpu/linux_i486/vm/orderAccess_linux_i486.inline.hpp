...
#pragma ident "@(#)orderAccess_linux_i486.inline.hpp	1.5 03/12/23 16:38:07 JVM"
#endif
//
...
inline void     OrderAccess::store_ptr_fence(intptr_t* p, intptr_t v) { store_fence((jint*)p, (jint)v); }
inline void     OrderAccess::store_ptr_fence(void**    p, void*    v) { store_fence((jint*)p, (jint)v); }
...
inline void     OrderAccess::release_store_ptr_fence(volatile intptr_t* p, intptr_t v) { release_store_fence((volatile jint*)p, (jint)v); }
inline void     OrderAccess::release_store_ptr_fence(volatile void*     p, void*    v) { release_store_fence((volatile jint*)p, (jint)v); }
