#
# @(#)sa.make	1.22 04/04/28 14:30:59
#
...
$(GENERATED)/sa-jdi.jar: $(AGENT_ALLFILES)
	...
	$(QUIETLY) $(RUN.JAVAH) -classpath $(GENERATED)/saclasses -d $(GENERATED) -jni sun.jvm.hotspot.debugger.x86.X86ThreadContext
	$(QUIETLY) $(RUN.JAVAH) -classpath $(GENERATED)/saclasses -d $(GENERATED) -jni sun.jvm.hotspot.debugger.ia64.IA64ThreadContext
	$(QUIETLY) $(RUN.JAVAH) -classpath $(GENERATED)/saclasses -d $(GENERATED) -jni sun.jvm.hotspot.debugger.amd64.AMD64ThreadContext
