/*
 * @(#)Globals_pre.java	1.111 08/01/18
 *
...
public class Globals {
     ...
     * will have to change.
     */
    private static final String JAVAWS_NAME = "javaws-1.6.0_10";

    public static final String JAVAWS_VERSION = "1.6.0_10";
    ...
    private static boolean _isJavaFxMode = false;
	...
	return _isSilentMode && (Environment.isImportMode() || 
    ...
    // only enable JavaFx mode if import
    static public boolean isJavaFxMode() {
        return _isJavaFxMode && Environment.isImportMode();
    }
    ...
    static public void setJavaFxMode(boolean s) { _isJavaFxMode = s; }
