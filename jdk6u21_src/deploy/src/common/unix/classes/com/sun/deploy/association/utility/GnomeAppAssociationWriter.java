...
public class GnomeAppAssociationWriter implements AppAssociationWriter {
     ...
     * the mime-info and application-registry directories. If the directories
    ...
    /**
     * Writes association fields into specified .mime file, including mime type, and extension list.      
     */
     ...
     * @param level a given MIME database level, which is NOT used here.
     * @return true if the given association is valid.
