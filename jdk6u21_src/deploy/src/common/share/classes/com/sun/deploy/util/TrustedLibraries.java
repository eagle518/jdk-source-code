/*
 * @(#)TrustedLibraries.java	1.3 10/05/20
 *
...
public final class TrustedLibraries {
    ...
    /**
     * The hashmap of trusted libraries list entries. The key is the X-DIGEST-MANIFEST
    ...
    /**
     * Timestampt of last modification of trusted libraries list files.
     */
    private static long lastModified = 0;

    // Trying to load TrustedLibraries object if the property is turned on
    static {
    ...
    /**
     * Returns the singleton TrustedLibraries instance.
     *
     * @throws TrustedLibrariesSyntaxException if there is an error parsing the
     *    trusted libraries list
     */
    ...
    private TrustedLibraries() {
        try {
	    // Get trusted libraries file from user and system directory
    ...
    /**
     * Returns true if this trusted libraries list contains no entry.
     *
     * @returns true if this trusted libraries list contains no entry.
     *
     */
    ...
    /**
     * Returns true if this trusted libraries list contains an entry for the specified
     * digest manifest attribute and hash.
     *
     * @param attribute the digest manifest attribute
     * @param hash the base64 encoded hash value
     * @return true if this trusted libraries list contains an entry for the specified
     *  attribute and hash
     */
    ...
    /* Returns true if file is in the trusted libraries list, false otherwise */
...
class TrustedLibrariesSyntaxException extends RuntimeException {
    TrustedLibrariesSyntaxException(Exception e) {
        super(e);
    }
}
