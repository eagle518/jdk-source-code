...
public class JarDiff implements JarDiffConstants {
	...
	boolean minimal = true;
		...
		minimal = false;
			...
			try {
			    System.out.println(ResourceManager.getString(
                                    "jardiff.error.create", ioe.toString()));
			...
			try {
			    System.out.println(ResourceManager.getString(
                                    "jardiff.error.apply", ioe.toString()));
			} catch (MissingResourceException mre) {
			}
                    }
                }
