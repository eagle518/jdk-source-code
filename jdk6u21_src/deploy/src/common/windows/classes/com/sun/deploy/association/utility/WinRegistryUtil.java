...
public class WinRegistryUtil {
    ...
    */
     ...
     *
     * Note: Do not set the default value for for the verbs: open, print, or
     *       printto.  Windows uses these keys to display specific text.
     *
    ...
    private static void addActionByClsID(Action action, String clsID, int regLevel) throws RegisterFailedException {
        ...
        if ((clsIDKey != null) && (verb != null)) {
            String shellKey = clsIDKey + "\\" + KN_SHELL;
            String verbKey  = shellKey + "\\" + verb;
            String cmdKey   = verbKey + "\\" + KN_COMMAND;

            if ((desc == null) ||
                (verb.equalsIgnoreCase("open") == true) ||
                (verb.equalsIgnoreCase("print") == true) ||
                (verb.equalsIgnoreCase("printto") == true)) {
                // set description to the empty string, so system will use the
                // default text for the locale
                desc = "";
            }
     ...
     *
     * @param iconFile given icon file name (not null)
     ...
     */
    public static List getActionListByFileExt(String fileExt, int regLevel) {
     ...
     * @return the action list
     */
    public static List getActionListByFileExt(String fileExt) {
        List rootActionList = getActionListByFileExt(fileExt, ROOT_LEVEL);
        List userDefinedList = getUserAddedActionListByFileExt(fileExt);
     ...
     * @return the action list
     */
    private static List getUserAddedActionListByFileExt(String fileExt) {
     ...
     * @exception RegisterFailedException
     */
    public static void setActionListByFileExt(List actionList, String fileExt, int regLevel) throws RegisterFailedException {
    ...
    public static void removeFileExt(String fileExt, int regLevel)
        ...
        if (isFileExtExist(fileExt, regLevel)) {
            ...
            if (clsID != null) {
                String clsIDKey = getClsIDKey(clsID, regLevel);
                if (clsIDKey != null) {
                    String value_generator = regQueryValueEx(clsIDKey, VN_DEFAULTGENERATOR, regLevel);
                    if (value_generator.compareTo(VALUE_DEFAULTGENERATOR) == 0) {
                        //The classID is generated by us, we should remove the clssID
    ...
    public static String getClassIDByFileExt(String fileExt, int regLevel) {
        ...
        if (fileExtKey != null) {
           if (isSubKeyExist(fileExtKey, regLevel)) {
               return getDefaultValue(fileExtKey, regLevel);
           }
        }
        return null;
    }
