/*
 * @(#)MNetscape4BrowserService.java	1.40 10/03/24
 *
 ...
 */
public final class MNetscape4BrowserService extends MPlatformService implements BrowserService
{
    /**
    ...
    {
	return new com.sun.deploy.net.proxy.MNetscape4ProxyConfig();
    }
    /**
