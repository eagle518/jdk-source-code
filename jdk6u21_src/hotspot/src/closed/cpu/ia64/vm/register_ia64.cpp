...
const int ConcreteRegisterImpl::max_pred = ConcreteRegisterImpl::max_fpr +
                                                                 2 * PredicateRegisterImpl::number_of_registers;
const int ConcreteRegisterImpl::max_branch = ConcreteRegisterImpl::max_pred +
                                                                 2 * BranchRegisterImpl::number_of_registers;
const int ConcreteRegisterImpl::max_app = ConcreteRegisterImpl::max_branch +
                                                                 2 * ApplicationRegisterImpl::number_of_registers;
