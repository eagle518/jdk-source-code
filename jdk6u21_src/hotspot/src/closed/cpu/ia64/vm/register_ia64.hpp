...
public:
  ...
  // general construction
  inline friend PredicateRegister as_PredicateRegister(int encoding);
...
public:
  ...
  // general construction
  inline friend BranchRegister as_BranchRegister(int encoding);
...
public:
  ...
  // general construction
  inline friend ApplicationRegister as_ApplicationRegister(int encoding);
...
public:
  ...
  // Determine if there is an overlap
  bool overlaps(ApplicationRegisterImplMask &_arg) { return is_set(_arg) != 0; }
};
...
public:
  ...
  bool is_set_pr()   { return _pr.is_set() != 0; }
...
public:
  // This value is important for setting the number of bits/slots in registerMaps. It is
  // important that the number is large enough so that for any OptoReg/VMRegImpl that gets
  // produced by mapping an actual physical register does not exceed this limit.
  //
  ...
  enum {
    number_of_registers =  (RegisterImpl::number_of_registers +
                            ...
                            (BranchRegisterImpl::number_of_registers * 2)
  };

  static const int max_gpr;
  static const int max_fpr;
  static const int max_pred;
  static const int max_branch;
  static const int max_app;
...
inline  Register as_Register(int encoding) { return ((Register)(intptr_t)(encoding)) ; }
inline  FloatRegister as_FloatRegister(int encoding) { return ((FloatRegister)(intptr_t)(encoding)) ; }
inline  BranchRegister as_BranchRegister(int encoding) { return ((BranchRegister)(intptr_t)(encoding)) ; }
inline  PredicateRegister as_PredicateRegister(int encoding) { return ((PredicateRegister)(intptr_t)(encoding)) ; }
inline  ApplicationRegister as_ApplicationRegister(int encoding) { return ((ApplicationRegister)(intptr_t)(encoding)) ; }
