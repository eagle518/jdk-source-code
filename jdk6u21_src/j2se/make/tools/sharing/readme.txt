...
bootclasspath classes are loaded from rt.jar.  The MakeClasslist program is run
on one of the logs from each of the benchmarks in the following fashion:

cd .../results.startup3
$JAVA_HOME/bin/java -cp $JDK_WS/make/tools/sharing MakeClasslist results.Noop/results_1/log results.Framer/results_1/log results.XFramer/results_1/log results.JEdit/results_1/log results.LimeWire/results_1/log results.NetBeans/results_1/log
...
In a forthcoming J2SE build we plan to manually add the dependent
