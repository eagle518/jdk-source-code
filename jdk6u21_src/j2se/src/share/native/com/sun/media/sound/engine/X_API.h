 ...
 * or for older 32-bit Windows header files (_MSC_VER < 1310)
 */
#if (X_PLATFORM != X_WINDOWS) || (defined(i586) && defined(_MSC_VER) && (_MSC_VER < 1310))
...
#endif /* X_PLATFORM not Windows, or old Windows 32 */
