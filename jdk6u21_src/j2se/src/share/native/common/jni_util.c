...
static jmethodID String_byte_constructor; /* new String(byte[]) */
...
initializeEncoding(JNIEnv *env)
{
    ...
    String_byte_constructor = (*env)->GetMethodID(env, JNU_ClassString(env),
		 "<init>", "([B)V");
}
