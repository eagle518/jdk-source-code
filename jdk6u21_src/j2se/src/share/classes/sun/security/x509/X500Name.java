...
public class X500Name implements GeneralNameInterface, Principal {
    ...
    public X500Name(String dname) throws IOException {
        this(dname, (Map<String, String>) Collections.EMPTY_MAP);
    }
    ...
    public X500Name(String dname, String format) throws IOException {
	    ...
	    parseDN(dname, (Map<String, String>) Collections.EMPTY_MAP);
	} else {
	...
	return getRFC1779Name((Map<String, String>) Collections.EMPTY_MAP);
    }
	...
	return getRFC2253Name((Map<String, String>) Collections.EMPTY_MAP);
    }
