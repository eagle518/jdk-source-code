/*
 * @(#)X11CachingSurfaceManager.c	1.16 10/03/23
 *
...
#include "sun_java2d_x11_X11CachingSurfaceManager.h"
#include "malloc.h"
...
/*
 * Class:     sun_java2d_x11_X11CachingSurfaceManager
 * Method:    updateBitmask
 * Signature: (Lsun/java2d/SurfaceData;JII)J
 */

JNIEXPORT jint JNICALL
Java_sun_java2d_x11_X11CachingSurfaceManager_updateBitmask
