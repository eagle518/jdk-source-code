/*
 * @(#)X11GraphicsConfig.java	1.75 10/03/23
 *
...
public class X11GraphicsConfig extends GraphicsConfiguration {
	...
	WritableRaster raster =
        ...
        // this causes some per-pixel operations to be very slow
...
//	}
    ...
    /**
     * Convenience method used from native code (X11Color.c) to create 
     * translucent surfaces of ARGB type 
     */
    private static DirectColorModel createDCM32(int rMask, int gMask, 
                                                int bMask, int aMask, 
                                                boolean aPre) {
    ...
    /**
     * Convenience method used from native code (X11Color.c) to create 
     * translucent surfaces of ABGR type 
     */
    private static ComponentColorModel createABGRCCM() {
