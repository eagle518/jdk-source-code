/*
 * @(#)MFontConfiguration.java	1.28 10/03/23
 *
...
// 	reorderMap.put("ISO-8859-1", "latin-1");
    ...
    protected void setOsNameAndVersion(){
        ...
        if (osName.equals("SunOS")) {
            if (SunGraphicsEnvironment.isOpenSolaris) {
                osName = "OpenSolaris";
            } else {
                // We don't use os name in Solaris fontconfig file names.
                osName = null;
            }
    ...
    private void initTables() {
        ...
        if (osName == null || osName.equals("OpenSolaris")) {
