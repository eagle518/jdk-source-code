/* 
 * @(#)XMenuItemPeer.java	1.24 10/03/23
 *
...
public class XMenuItemPeer implements MenuItemPeer {
    ...
    static {
        f_enabled = XToolkit.getField(MenuItem.class, "enabled");
        f_label = XToolkit.getField(MenuItem.class, "label");
        f_shortcut = XToolkit.getField(MenuItem.class, "shortcut");

        m_getFont = XToolkit.getMethod(MenuComponent.class, "getFont_NoClientCode", null);
        m_getActionCommand = XToolkit.getMethod(MenuItem.class, "getActionCommandImpl", null);
        m_isItemEnabled = XToolkit.getMethod(MenuItem.class, "isItemEnabled", null);
    }
    /************************************************
     *
     * Text Metrics
