/*
 * @(#)XWarningWindow.java	1.21 10/03/23
 *
...
class XWarningWindow extends XWindow {
    ...
    private XTrayIconPeer.Tooltip tooltip;
    ...
    XWarningWindow(Window ownerWindow, long parentWindow, XWindowPeer ownerPeer) {
        ...
        this.tooltip = new XTrayIconPeer.Tooltip(this, null,
                ownerWindow.getWarningString());
    ...
    void postInit(XCreateWindowParams params) {
        ...
        try {
            ...
            hints.set_flags(hints.get_flags() | (int)XlibWrapper.InputHint | (int)XlibWrapper.StateHint);
            hints.set_input(false);
            hints.set_initial_state(XlibWrapper.NormalState);
