...
#pragma ident "@(#)orderAccess_linux_ia64.inline.hpp	1.4 03/12/23 16:38:12 JVM"
#endif
//
...
inline void OrderAccess::acquire() {
  intptr_t load_dummy;
  __asm__ volatile ("ld8.acq %0=[sp]" : "=r" (load_dummy));
}

inline void OrderAccess::release() {
  __asm__ volatile ("st8.rel [sp]=r0" : : : "memory");
}
...
// 'volatile' causes the compiler to generate ld.acq.
...
// 'volatile' causes the compiler to generate st.rel.
