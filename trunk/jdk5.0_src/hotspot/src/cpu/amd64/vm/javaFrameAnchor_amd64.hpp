...
#pragma ident "@(#)javaFrameAnchor_amd64.hpp	1.3 03/12/23 16:35:51 JVM"
#endif
/*
...
private:
  ...
  intptr_t* volatile _last_Java_fp; // pointer is volatile not what it
                                    // points to
...
public:
  ...
  // Never any thing to do since we are always walkable and can find
  // address of return addresses
  ...
  // These are only used by friends. Using the mutators in the wrong
  // order is dangerous.
