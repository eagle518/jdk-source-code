...
#pragma ident "@(#)interp_masm_amd64.hpp	1.6 04/03/22 19:28:49 JVM"
#endif
/*
  ...
  : public MacroAssembler 
{
 ...
 public:
  ...
  void call_VM_Ico(Register oop_result,
                   address entry_point,
                   Register arg_1,
  ...
  void super_call_VM(Register oop_result, Register last_java_sp, 
