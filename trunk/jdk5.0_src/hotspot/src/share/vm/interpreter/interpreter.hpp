...
#pragma ident "@(#)interpreter.hpp	1.134 03/12/23 16:40:38 JVM"
#endif
/*
...
// contain extra information for safepoint, debugging and
// printing purposes.
...
class InterpreterCodelet: public Stub {
 ...
 private:
  ...
  bool        _is_safepoint_safe;                // true if thread cannot escape interpreter during a safepoint, false otherwise
 ...
 public:
  ...
  void    initialize(const char* description, bool is_safepoint_safe, Bytecodes::Code bytecode);

  // Interpreter-specific attributes
  int         code_size() const                  { return code_end() - code_begin(); }
  const char* description() const                { return _description; }
  bool        is_safepoint_safe() const          { return _is_safepoint_safe; }
...
class AbstractInterpreter: AllStatic {
 ...
 public:
  ...
  static void       layout_activation(methodOop method,
				      int temps,
				      int monitors,
				      int callee_params,
				      int callee_locals,
...
#ifndef CORE
  // Deoptimization
  static int        layout_activation_impl(methodOop method,
					   int temps,
					   int monitors,
					   int callee_params,
					   int callee_locals,
