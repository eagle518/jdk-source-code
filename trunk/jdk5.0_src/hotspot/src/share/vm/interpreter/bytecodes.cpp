...
#pragma ident "@(#)bytecodes.cpp	1.85 03/12/23 16:40:35 JVM"
#endif
/*
...
u_char          Bytecodes::_can_trap      [Bytecodes::number_of_codes];
u_char          Bytecodes::_safepoint_safe[Bytecodes::number_of_codes];
Bytecodes::Code Bytecodes::_java_code     [Bytecodes::number_of_codes];
u_char          Bytecodes::_can_rewrite   [Bytecodes::number_of_codes];
...
void Bytecodes::def(Code code, const char* name, const char* format, const char* wide_format, BasicType result_type, int depth, bool can_trap, bool safepoint_safe) {
  def(code, name, format, wide_format, result_type, depth, can_trap, code, safepoint_safe);
}


void Bytecodes::def(Code code, const char* name, const char* format, const char* wide_format, BasicType result_type, int depth, bool can_trap, Code java_code, bool safepoint_safe) {
  ...
  _depth         [code] = depth;
  _can_trap      [code] = (u_char)can_trap;
  _safepoint_safe[code] = (u_char)safepoint_safe;
...
void Bytecodes::initialize() {
  ...
  def(_ifeq                , "ifeq"                , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_ifne                , "ifne"                , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_iflt                , "iflt"                , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_ifge                , "ifge"                , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_ifgt                , "ifgt"                , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_ifle                , "ifle"                , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_if_icmpeq           , "if_icmpeq"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_if_icmpne           , "if_icmpne"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_if_icmplt           , "if_icmplt"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_if_icmpge           , "if_icmpge"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_if_icmpgt           , "if_icmpgt"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_if_icmple           , "if_icmple"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_if_acmpeq           , "if_acmpeq"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_if_acmpne           , "if_acmpne"           , "boo"  , NULL    , T_VOID   , -2, false, false);
  def(_goto                , "goto"                , "boo"  , NULL    , T_VOID   ,  0, false, false);
  ...
  def(_ireturn             , "ireturn"             , "b"    , NULL    , T_INT    , -1, true , false);
  def(_lreturn             , "lreturn"             , "b"    , NULL    , T_LONG   , -2, true , false);
  def(_freturn             , "freturn"             , "b"    , NULL    , T_FLOAT  , -1, true , false);
  def(_dreturn             , "dreturn"             , "b"    , NULL    , T_DOUBLE , -2, true , false);
  def(_areturn             , "areturn"             , "b"    , NULL    , T_OBJECT , -1, true , false);
  def(_return              , "return"              , "b"    , NULL    , T_VOID   ,  0, true , false);
  ...
  def(_invokevirtual       , "invokevirtual"       , "bjj"  , NULL    , T_ILLEGAL, -1, true, false ); 
  def(_invokespecial       , "invokespecial"       , "bjj"  , NULL    , T_ILLEGAL, -1, true, false );
  def(_invokestatic        , "invokestatic"        , "bjj"  , NULL    , T_ILLEGAL,  0, true, false );
  def(_invokeinterface     , "invokeinterface"     , "bjj__", NULL    , T_ILLEGAL, -1, true, false );
  ...
  def(_ifnull              , "ifnull"              , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_ifnonnull           , "ifnonnull"           , "boo"  , NULL    , T_VOID   , -1, false, false);
  def(_goto_w              , "goto_w"              , "boooo", NULL    , T_VOID   ,  0, false, false);
  def(_jsr_w               , "jsr_w"               , "boooo", NULL    , T_INT    ,  0, false);
  def(_breakpoint          , "breakpoint"          , ""     , NULL    , T_VOID   ,  0, true , true            );
  ...
  def(_fast_invokevfinal   , "fast_invokevfinal"   , "bjj"  , NULL    , T_ILLEGAL, -1, true, _invokevirtual, false ); 
