...
#pragma ident "@(#)templateTable.hpp	1.80 03/12/23 16:40:45 JVM"
#endif
/*
...
class TemplateTable: AllStatic {
 ...
 private:
  ...
  static void load_field_cp_cache_entry(int byte_no,
                                        Register obj,
                                        Register offset,
                                        Register flags,
                                        bool is_static);
  ...
  // jvmti support
  static void jvmti_post_field_access(int byte_no, bool is_static, bool has_tos);
  static void jvmti_post_field_mod(int byte_no, bool is_static);
