...
<xsl:template match="inbuf" mode="funcdescription">
  <p/>
  <xsl:variable name="child" select="child::*[position()=1]"/>
  <xsl:text>Agent passes in an array</xsl:text>
  <xsl:if test="name($child)!='void'">
...
<xsl:template match="jmethodID|jfieldID|jframeID|jrawMonitorID|jclass|jobject|jvalue|jthreadGroup|enum|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|void|varargs|struct" mode="funcdescription">
</xsl:template>
...
<xsl:template match="jmethodID|jfieldID|jframeID|jrawMonitorID|enum|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|void|varargs" mode="returndescription">
</xsl:template>

<xsl:template match="struct" mode="returndescription">
  <xsl:param name="plural"/>
  <xsl:variable name="structname" select="."/>
  <xsl:for-each select="//typedef[@id=$structname]">
...
<xsl:template match="ptrtype|vmbuf|jmethodID|jfieldID|jframeID|jrawMonitorID|enum|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|void" mode="fieldreturndescription">
</xsl:template>
...
<xsl:template match="jmethodID|jfieldID|jrawMonitorID|jclass|jthread|jobject|jvalue|jthreadGroup|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|void" mode="signature">
...
<xsl:template match="jmethodID|jfieldID|jrawMonitorID|jclass|jthread|jobject|jvalue|jint|jlong|jfloat|jdouble|jlocation|jboolean|jthreadGroup" mode="link">
  <a>
...
<xsl:template match="char|void" mode="link">
    <xsl:value-of select="name()"/>
</xsl:template>
...
<xsl:template match="jmethodID|jfieldID|jframeID|jrawMonitorID|jclass|jobject|jvalue|jthreadGroup|jthread|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|void" mode="btsig">
  <xsl:value-of select="name()"/>
</xsl:template>
...
<xsl:template match="jobject|jvalue|jthreadGroup|enum|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|void|struct" mode="HotSpotType">
...
<xsl:template match="jobject|jvalue|jthreadGroup|enum|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|void|varargs|struct|outptr|outbuf|allocfieldbuf|ptrtype|inptr|inbuf|vmbuf|allocbuf|agentbuf|allocallocbuf" mode="HotSpotName">
  <xsl:param name="name"/>
  <xsl:value-of select="$name"/>
</xsl:template>
...
<xsl:template match="jobject|jvalue|jthreadGroup|enum|jint|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|void|struct|outptr|outbuf|allocfieldbuf|ptrtype|inptr|inbuf|vmbuf|allocbuf|agentbuf|allocallocbuf" mode="HotSpotValue">
  <xsl:param name="name"/>
  <xsl:value-of select="$name"/>
</xsl:template>
