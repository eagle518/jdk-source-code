...
#pragma ident "@(#)jmm.h	1.19 04/04/02 16:11:36 JVM"
#endif
/*
 *
...
// This enum can be removed after JDK for Thread.State support is promoted
typedef enum {
...
enum {
  JMM_THREAD_STATE_FLAG_MASK      = 0xFFF00000,
