...
#pragma ident "@(#)formsopt.hpp	1.43 03/12/23 16:38:51 JVM"
#endif
/*
...
public:
  // Public Data
  const char *_regname;            // Register name
...
public:
  ...
  char *_interpreter_arg_ptr_reg;
  char *_compiler_method_oop_reg;
