...
#pragma ident "@(#)formsopt.cpp	1.44 03/12/23 16:38:50 JVM"
#endif
/*
...
void RegisterForm::addRegDef(char *name, char *callingConv, char *c_conv,
  ...
  RegDef *regDef = new RegDef(name, callingConv, c_conv, idealtype, encoding);
  _rdefs.addName(name);
...
//------------------------------RegDef-----------------------------------------
// Constructor
RegDef::RegDef(char *regname, char *callconv, char *c_conv, char * idealtype, char * encode)
