...
#pragma ident "@(#)filemap.cpp	1.11 04/05/21 11:28:46 JVM"
#endif
/*
...
void FileMapInfo::populate_header() {
...
char* FileMapInfo::map_region(int i, ReservedSpace rs) {
  ...
  ReservedSpace mapped_rs = rs.first_part(size, true, false);
