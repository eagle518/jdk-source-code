...
#pragma ident "@(#)mulnode.hpp	1.46 03/12/23 16:42:43 JVM"
#endif
/*
...
public:
  ...
  // Is this Node an MulNode or some descendent?  Default is YES.
  virtual const MulNode *is_Mul() const { return this; }
};
