...
#pragma ident "@(#)indexSet.hpp	1.22 03/12/23 16:42:32 JVM"
#endif
/*
...
class IndexSet : public ResourceObj {
 ...
 public:
  ...
  static void reset_memory(Arena *arena) {
 ...
 public:
  ...
  // When asserts are on, each IndexSet is given a unique serial number.  Using the
  // -XX:IndexSetWatch option, one can trace operations on a specified set or all sets.
  static int _watch_number;
