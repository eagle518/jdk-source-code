...
#pragma ident "@(#)fieldDescriptor.hpp	1.39 03/12/23 16:43:38 JVM"
#endif
/*
...
class fieldDescriptor VALUE_OBJ_CLASS_SPEC {
 ...
 public:
  ...
  symbolOop generic_signature() const  { return (_generic_signature_index > 0 ? _cp->symbol_at(_generic_signature_index) : NULL); }
