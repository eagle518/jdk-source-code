/*
 * @(#)ConsoleWindow.java	1.90 04/01/12
 *
...
public final class ConsoleWindow extends JFrame
{
    ...
    public static ConsoleWindow create(ConsoleController controller)
    {
	...
	ActionListener dumpThreadStack = new ActionListener()
	{
		...
		buffer.append(ResourceManager.getMessage("console.dump.stack"));
	...
	ActionListener showThreads = new ActionListener()
	{
		...
		buffer.append(ResourceManager.getMessage("console.dump.thread"));
	...
	ActionListener logging = new ActionListener()
	{
	    public void actionPerformed(ActionEvent e)
	    {
		System.out.println(ResourceManager.getMessage("console.log")
	...
	/* Get our resource strings.  We are guaranteed that ResourceManager
         ...
         */
	JButton clear = new JButton(ResourceManager.getMessage("console.clear"));
	clear.setMnemonic(ResourceManager.getAcceleratorKey("console.clear"));
	JButton copy = new JButton(ResourceManager.getMessage("console.copy"));
	copy.setMnemonic(ResourceManager.getAcceleratorKey("console.copy"));
	JButton close = new JButton(ResourceManager.getMessage("console.close"));
	close.setMnemonic(ResourceManager.getAcceleratorKey("console.close"));
