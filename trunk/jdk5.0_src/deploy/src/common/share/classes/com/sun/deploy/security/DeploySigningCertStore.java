/*
 * @(#)DeploySigningCertStore.java	1.42 04/02/18 
 *
...
public final class DeploySigningCertStore implements CertStore
{
	...
	String alias = _deploymentSystemCerts.getCertificateAlias(cert);

	if (alias != null) {
	    return true;	// in system certs store
	}
	...
	return (storeType == CertStore.USER) ? 
		_deploymentUserCerts : _deploymentSystemCerts ;
    }
}
