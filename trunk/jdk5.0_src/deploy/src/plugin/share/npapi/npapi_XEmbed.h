/* -*- Mode: C; tab-width: 4; -*- */
/*
 *  npapi_XEmbed.h: this is our version of npapi.h to support XEmbed for now.
 */

#ifndef _NPAPI_XEMBED_H_
#define _NPAPI_XEMBED_H_
...
/*
 * The following NPPVariable and NPNVariable have support for XEmbed.
 */
