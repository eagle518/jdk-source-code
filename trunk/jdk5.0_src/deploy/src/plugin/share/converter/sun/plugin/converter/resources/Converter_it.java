/*
 * @(#)Converter_it.java	1.35 04/06/18
 *
...
/**
 * Italian version of Java Plug-in HTML Converter strings.
 *
...
public class Converter_it extends ListResourceBundle {
    ...
    { "caption.reldirnotfound", "Impossibile trovare la cartella relativa" },
        { "about_dialog.info", "Convertitore HTML di Java(TM) Plug-in v{0}" + newline + 
