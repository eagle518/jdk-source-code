/*
 * @(#)CSSStyleSheet.java	1.3 03/12/19
 *
...
public class CSSStyleSheet extends sun.plugin.dom.stylesheets.StyleSheet
     ...
     */
    public CSSStyleSheet(DOMObject obj, org.w3c.dom.Document doc, org.w3c.dom.Node owner) {
	super(obj, doc, owner);
    }
	...
	Object result = null;	    	    
	try {
	    result = obj.getMember(CSSConstants.ATTR_CSS_RULES);
	} catch (DOMException e) {
	}

	if (result == null) {
	    result = obj.getMember(CSSConstants.ATTR_RULES);
	}

	if (result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createCSSObject((DOMObject)result, doc, owner, this, null);
	    if(ret != null && ret instanceof org.w3c.dom.css.CSSRuleList)
		return (org.w3c.dom.css.CSSRuleList)ret;
	}
