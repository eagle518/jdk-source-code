...
public abstract class Node implements org.w3c.dom.Node {
	...
	Object result = null;
	try {
	    result = obj.getMember(ATTR_CHILDREN);
	...
	if(result == null)
    	    result = obj.getMember(ATTR_CHILD_NODES);

	if(result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result, getOwnerDocument());
	...
	Object result = obj.getMember(ATTR_PARENT_NODE);
	if(result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result, getOwnerDocument());
	    if(ret != null && ret instanceof org.w3c.dom.Node)
		return (org.w3c.dom.Node)ret;
	}
	...
	Object result = obj.getMember(ATTR_PREVIOUS_SIBLING);
	if(result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result, getOwnerDocument());
	    if(ret != null && ret instanceof org.w3c.dom.Node)
		return (org.w3c.dom.Node)ret;
	...
	Object result = obj.getMember(ATTR_NEXT_SIBLING);
	if(result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result, getOwnerDocument());
	    if(ret != null && ret instanceof org.w3c.dom.Node)
		return (org.w3c.dom.Node)ret;
	...
	if(newChild != null && refChild != null) {
		...
		Object result = obj.call(FUNC_INSERT_BEFORE, new Object[]{ newNode.obj.getJSObject(),
									   newRefNode.obj.getJSObject()});
		if(result != null && result instanceof DOMObject) {
		    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result,
									getOwnerDocument());
		    if(ret != null && ret instanceof org.w3c.dom.Node) {
			return (org.w3c.dom.Node)ret;
		    }
	...
	if(newChild != null && oldChild != null) {
		...
		Object result = obj.call(FUNC_REPLACE_CHILD, new Object[]{ newNode.obj.getJSObject(),
	...
	if(oldChild != null) {
		...
		Object result = obj.call(FUNC_REMOVE_CHILD, new Object[]{ node.obj.getJSObject()});
		if(result != null && result instanceof DOMObject) {
		    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result,
									getOwnerDocument());
		    if(ret != null && ret instanceof org.w3c.dom.Node)
	...
	if(newChild != null) {
		...
		Object result = obj.call(FUNC_APPEND_CHILD, new Object[]{node.obj.getJSObject()});
		if(result != null && result instanceof DOMObject) {
		    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result,
			    getOwnerDocument());
		    if(ret != null && ret instanceof org.w3c.dom.Node) {
	...
	return DOMObjectHelper.getBooleanMember(obj, ATTR_HAS_CHILD_NODES);
    }
	...
	Object result = obj.call(FUNC_CLONE_NODE, new Object[] {new Boolean(deep)});
	if(result != null && result instanceof DOMObject) {
	    Object ret = DOMObjectFactory.createCommonDOMObject((DOMObject)result,
								getOwnerDocument());
	    if(ret != null && ret instanceof org.w3c.dom.Node) {
		((DOMObject)result).lock();
		return (org.w3c.dom.Node)ret;
	    }
	}
