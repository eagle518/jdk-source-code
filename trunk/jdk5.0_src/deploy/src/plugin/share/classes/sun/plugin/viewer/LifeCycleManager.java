/*
 * @(#)LifeCycleManager.java	1.20 03/12/19
 *
...
public class LifeCycleManager
{
    ...
    /**
     * Initialize an applet through applet panel.
     *
     * @param panel Applet panel
     */
    public static void initAppletPanel(AppletViewer panel)
    {
	if (panel.getLoadingStatus() == sun.applet.AppletPanel.APPLET_INIT)
	{
	    // no-op
	} 
	else
