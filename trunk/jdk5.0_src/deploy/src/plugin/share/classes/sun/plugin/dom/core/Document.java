...
public abstract class Document extends sun.plugin.dom.core.Node
	...
	if (result != null && result instanceof DOMObject) {
	    return new sun.plugin.dom.core.DocumentFragment((DOMObject) obj, null);
	}
	return null;
    }
	...
	if (result != null && result instanceof DOMObject) {
	    return new sun.plugin.dom.core.Text((DOMObject) obj, null);
	}
	return null;
    }
	...
	if (result != null && result instanceof DOMObject) {
	    return new sun.plugin.dom.core.Comment((DOMObject) obj, null);
	}
	return null;
    }
