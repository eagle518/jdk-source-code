/*
 * @(#)HTMLFormElement.java	1.6 03/12/19
 *
			     ...
			     implements org.w3c.dom.html.HTMLFormElement
{
	...
	Object result = obj.getMember(HTMLConstants.MEMBER_ELEMENTS);
	if (result != null && result instanceof DOMObject) {
	    return new sun.plugin.dom.html.HTMLCollection((DOMObject)result, 
