/*
 * @(#)HTMLIFrameElement.java	1.2 03/12/19
 *
...
public final class HTMLIFrameElement extends HTMLElement 
    ...
    public HTMLIFrameElement(DOMObject obj, 
	...
	throw new sun.plugin.dom.exception.PluginNotSupportedException(
	    "HTMLIFrameElement.getContentDocument() is not supported.");
    }
