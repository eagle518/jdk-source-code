/*
 * @(#)CNSAdapter_PluginManager.cpp	1.7 03/12/19
 *
...
enum nsPluginManagerVariable_XEmbed {
...
CNSAdapter_PluginManager::GetValue(JDPluginManagerVariable variable, void* value)
{
    ...
    case JDPluginManagerVariable_SupportsXEmbed:
        ...
        tmpXEmbed = nsPluginManagerVariable_SupportsXEmbed;
        pVariable = nsPluginManagerVariable(tmpXEmbed);
        break;
#endif	// NO_XEMBED_MOZILLA
    default:
