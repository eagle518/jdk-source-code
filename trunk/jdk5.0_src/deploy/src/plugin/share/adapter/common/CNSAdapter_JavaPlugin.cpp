/*
 * @(#)CNSAdapter_JavaPlugin.cpp	1.6 03/12/19
 *
...
enum nsPluginInstanceVariable_XEmbed {
...
CNSAdapter_JavaPlugin::GetValue(nsPluginInstanceVariable variable, void* value)
{
...
#ifdef NO_XEMBED_MOZILLA
    nsPluginInstanceVariable_XEmbed variable_XEmbed;
    int tmpXEmbed;
#endif	// NO_XEMBED_MOZILLA
    ...
    default:
#ifdef NO_XEMBED_MOZILLA
            // Temporary hack to get usage of new XEmbed declarations to compile with
            // current (non-XEmbed) nsplugindefs.h.
	    tmpXEmbed = variable;
	    variable_XEmbed = nsPluginInstanceVariable_XEmbed(tmpXEmbed);
	    if (variable_XEmbed == nsPluginInstanceVariable_NeedsXEmbed)
