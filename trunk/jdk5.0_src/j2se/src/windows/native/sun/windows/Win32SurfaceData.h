/*
 * @(#)Win32SurfaceData.h	1.42 03/12/19
 *
...
typedef struct  {
    ...
    BOOL		    capsSet;
    BOOL		    canBlt;
    BOOL		    canCreateD3DSurfaces;
    BOOL		    canDrawD3dLines;
    BOOL		    canClipD3dLines;
    HWND		    hwndFullScreen;
    int			    backBufferCount;
    int			    context;
    BOOL                    accelerated;
...
#define TR_OPAQUE 1       /* Translucency.OPAQUE      */
#define TR_BITMASK 2      /* Translucency.BITMASK     */
#define TR_TRANSLUCENT 3  /* Translucency.TRANSLUCENT */
