/*
 * @(#)manifest_info.h	1.6 04/06/08
 *
 * Copyright 2004 Sun Microsystems, Inc. All rights reserved.
 * SUN PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 */

#ifndef _MANIFEST_INFO_H_
#define _MANIFEST_INFO_H_
 ...
 */
typedef void (*attribute_closure)(const char* name, const char* value, void* user_data);

/*
 * Function prototypes.
 */
int parse_manifest(char *jarfile, manifest_info *info);
void free_manifest();
int manifest_iterate(const char* jarfile, attribute_closure ac, void* user_data);

#endif /* _MANIFEST_INFO_H_ */
