...
/* place holder for old stubs, delete in the future. */
void
sun_awt_image_JPEGImageDecoder_readImage()
{}

void
sun_awt_image_JPEGImageDecoder_initIDs()
{}
