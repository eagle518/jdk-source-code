...
/*
 * $$kk: 06.23.99
 * This file contains header information for platform midi support.
 * This does not interface with the Beatnik engine at all.
 *
 * $$fb 2003-01-31: clean-up, use error messages
 *
 * $$ mp 2003-08-08: added MIDI_OUT_GetTimeStamp()
 */
