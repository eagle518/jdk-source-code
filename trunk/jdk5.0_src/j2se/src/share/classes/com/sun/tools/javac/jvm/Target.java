 ...
 */
public enum Target {
    /** We expect -target cldc1.0 to be documented to support CLDC. */
    ...
    public static final Target DEFAULT = JDK1_4;
    ...
    /** For -target cldc1.0, we generate cldc-style stack maps.  */
