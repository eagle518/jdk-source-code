/**
 * @(#)PackageDocImpl.java	1.45 04/05/19
 *
...
import static com.sun.tools.javac.tree.Tree.TopLevel;
...
public class PackageDocImpl extends DocImpl implements PackageDoc {
    ...
    private TopLevel tree = null;    // for source position
     ...
     */
    public PackageDocImpl(DocEnv env, PackageSymbol sym,
			  String documentation, Tree tree) {
        super(env, documentation);
        this.sym = sym;
	this.tree = (TopLevel) tree;
    ...
    public String name() {
        ...
        if (result.equals("unnamed package")) result = "";
        return result;
    }
	...
	return (tree != null)
		? SourcePositionImpl.make(tree.sourcefile + "", tree.pos)
