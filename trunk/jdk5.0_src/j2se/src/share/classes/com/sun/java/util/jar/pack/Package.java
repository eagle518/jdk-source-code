...
class Package implements Constants {
    ...
    short min_class_majver = 45;  // JDK 1.1 is 45.3
    short min_class_minver = 3;
    short max_class_majver = 49;  // JDK 1.5 is 49.0
    short max_class_minver = 0;
	...
	package_minver = JAVA_PACKAGE_MINOR_VERSION;
	package_majver = JAVA_PACKAGE_MAJOR_VERSION;
    }
	...
	return (default_class_minver << 16) + (char)default_class_minver;
    }
	...
	if (package_majver != JAVA_PACKAGE_MAJOR_VERSION ||
	    package_minver != JAVA_PACKAGE_MINOR_VERSION) {
