/*
 * @(#)CachedRowSetImpl.java	1.13 04/07/17  
 * 
...
public class CachedRowSetImpl extends BaseRowSet implements RowSet, RowSetInternal, Serializable, Cloneable, CachedRowSet {
    ...
    public CachedRowSetImpl(Hashtable env) throws SQLException {
        ...
        if (env == null) {
            throw new SQLException("Cannot instantiate CachedRowSetImpl " +
            "instance. Null Hashtable supplied to " +
            "constructor");
        }
    ...
    public void populate(ResultSet data) throws SQLException {
        ...
        if (data == null) {
            throw new SQLException("Invalid ResultSet object supplied to " +
            "populate method");
        }
