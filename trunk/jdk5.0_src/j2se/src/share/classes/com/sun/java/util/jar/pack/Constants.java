 ...
 * Shared constants
 * @author John Rose
 * @version 1.21, 06/12/04
 */
interface Constants {
    public final static int JAVA_MAGIC = 0xCAFEBABE;

    public final static int JAVA_PACKAGE_MAGIC = 0xCAFED00D;
    public final static int JAVA_PACKAGE_MAJOR_VERSION = 150;
    // This number is bumped on each output-changing putback, 
    // until JSR 200 is finalized.
    public final static int JAVA_PACKAGE_MINOR_VERSION = 7;
	...
	//CODE_ATTR_StackMap = 0,  // reserve this code
...
/*  // Comment out predefined StackMap bands, for now.
    // Union tags which select predefined bands.
    public static final int
	StackMap_RC_tag = 7,
	StackMap_uninit_P_tag = 8;
