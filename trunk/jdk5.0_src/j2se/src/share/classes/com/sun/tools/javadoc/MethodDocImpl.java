/**
 * @(#)MethodDocImpl.java	1.35 04/05/20
 *
...
public class MethodDocImpl
	...
	return TypeMaker.getType(env, sym.type.restype(), false);
    }
    ...
    public String qualifiedName() {
        return sym.enclClass().fullName() + "." + sym.name;
    }
