/*
 * @(#)DigestMD5Client.java	1.33 03/12/19
 *
...
final class DigestMD5Client extends DigestMD5Base implements SaslClient {
	...
	case 2:
	    ...
	    /* Get realm, qop, maxbuf, charset, algorithm, cipher, nonce 
	       directives */
	    List realmChoices = new ArrayList(3);
    ...
    */   
    private void processChallenge(byte[][] challengeVal, List realmChoices)
	...
	if (qopInChallenge == null) {	
	    ...
	    String qopOptions = new String(qopInChallenge, encoding);
