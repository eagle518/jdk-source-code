/**
 * @(#)AnnotationTypeDocImpl.java	1.6 04/04/08
 *
...
public class AnnotationTypeDocImpl
	...
	List<AnnotationTypeElementDoc> elements =
	    new List<AnnotationTypeElementDoc>();
