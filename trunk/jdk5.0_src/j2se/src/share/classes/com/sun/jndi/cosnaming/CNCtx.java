...
public class CNCtx implements javax.naming.Context {
    ...
    CNCtx(ORB orb, NamingContext nctx, Hashtable env, NameComponent[]name)
	throws NamingException {
...
"COS Name Service not registered with ORB under the name 'NameService'");
	...
	throws NamingException {
		...
		try {
		    ...
		    if (obj instanceof CNCtx) {
			return new CNBindingEnumeration((CNCtx)obj, _env); 
		    } else {
	    ...
	    return new CNBindingEnumeration(this, _env);
    }
