...
public class DocEnv {
     ...
     */
    void makePackageDoc(PackageSymbol pack, String docComment, TopLevel tree) {
	PackageDocImpl result = packageMap.get(pack);
	if (result != null) {
	...
	if (isAnnotationType(tree)) {	// flags of clazz may not yet be set
	    result = new AnnotationTypeDocImpl(this, clazz, docComment, tree);
	} else {
    ...
    private static boolean isAnnotationType(ClassDef tree) {
	...
	if (result != null) {
	    ...
	    result = new FieldDocImpl(this, var, docComment, tree);
	    fieldMap.put(var, result);
	}
    }
	...
	if (result != null) {
	    ...
	    result = new MethodDocImpl(this, meth, docComment, tree);
	...
	if (result != null) {
	    ...
	    result = new ConstructorDocImpl(this, meth, docComment, tree);
	    methodMap.put(meth, result);
	}
    }
	...
	if (result != null) {
	    ...
	    result =
		new AnnotationTypeElementDocImpl(this, meth, docComment, tree);
	    methodMap.put(meth, result);
	}
    }
