/*
 * @(#)ExtendedTextSourceLabel.java	1.28 03/12/19
 *
...
/*public*/ class ExtendedTextSourceLabel extends ExtendedTextLabel 
  ...
  protected Rectangle2D createAlignBounds() {
    CoreMetrics lm = source.getCoreMetrics();
  ...
  public Rectangle2D createItalicBounds() {
    CoreMetrics cm = source.getCoreMetrics();
