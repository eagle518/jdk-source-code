/*
 * @(#)DateFormatZoneData_fr.java	1.33 04/01/20
 */
...
public final class DateFormatZoneData_fr extends DateFormatZoneData
{
	...
	String LORD_HOWE[] = new String[] {"Heure standard de Load Howe", "LHST",
					   "Heure d'\u00e9t\u00e9 de Load Howe", "LHST"};
	...
	return new Object[][] {
	    ...
	    {"Asia/Chongqing", CTT},
	    {"Asia/Chungking", CTT},
	    {"Asia/Colombo", new String[] {"Heure du Sri Lanka", "LKT", "Heure d'\u00e9t\u00e9 du Sri Lanka", "LKST"}},
	    {"Asia/Dacca", BDT},
	    {"Asia/Dhaka", BDT},
	    {"Asia/Dili", new String[] {"Heure d'Est de Timor", "TPT", "Heure d'\u00e9t\u00e9 d'Est de Timor", "TPST"}},
	    {"Asia/Damascus", EET},
	    {"Asia/Dubai", GST},
	    ...
	    {"Pacific/Rarotonga", new String[] {"Heure des \u00celes Cook", "CKT", "Heure d'\u00e9t\u00e9 des \u00celes Cook", "CKST"}},
            {"Pacific/Saipan", ChST},
	    {"Pacific/Samoa", SAMOA},
