/*
 * @(#)DateFormatZoneData_de.java	1.35 04/03/08
 */
...
public final class DateFormatZoneData_de extends DateFormatZoneData
{
	...
	return new Object[][] {
	    ...
	    {"Asia/Chongqing", CTT},
	    {"Asia/Chungking", CTT},
	    {"Asia/Colombo", new String[] {"Sri Lanka Zeit", "LKT", "Sri Lanka Sommerzeit", "LKST"}},
	    {"Asia/Dacca", BDT},
	    {"Asia/Dhaka", BDT},
	    {"Asia/Dili", new String[] {"Osttimor Zeit", "TPT", "Osttimor Sommerzeit", "TPST"}},
	    {"Asia/Damascus", EET},
	    {"Asia/Dubai", GST},
	    ...
	    {"Pacific/Rarotonga", new String[] {"Cook-Inseln Zeit", "CKT", "Cook-Inseln Sommerzeit", "CKST"}},
	    {"Pacific/Saipan", ChST},
	    {"Pacific/Samoa", SAMOA},
