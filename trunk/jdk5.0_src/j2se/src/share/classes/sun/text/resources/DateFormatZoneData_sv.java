/*
 * @(#)DateFormatZoneData_sv.java	1.33 04/01/20
 */
...
public final class DateFormatZoneData_sv extends DateFormatZoneData
{
	...
	return new Object[][] {
	    ...
	    {"Asia/Chongqing", CTT},
	    {"Asia/Chungking", CTT},
	    {"Asia/Colombo", new String[] {"Sri Lanka, normaltid", "LKT",
					   "Sri Lanka, sommartid", "LKST"}},
	    {"Asia/Dacca", BDT},
	    {"Asia/Dhaka", BDT},
	    {"Asia/Dili", new String[] {"\u00d6sttimor, normaltid", "TPT",
					"\u00d6sttimor, sommartid", "TPST"}},
	    {"Asia/Damascus", EET},
	    {"Asia/Dubai", GST},
