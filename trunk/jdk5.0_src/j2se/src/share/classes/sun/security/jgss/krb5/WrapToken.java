...
class WrapToken extends MessageToken {
	...
	*/
	...
	if (!privacy) {
	    ...
	    cipherHelper.encryptData(confounder, 
	...
	if (!privacy) {
	    ...
	    cipherHelper.encryptData(confounder, dataBytes, dataOffset,
		dataLen, padding, outToken, offset);
