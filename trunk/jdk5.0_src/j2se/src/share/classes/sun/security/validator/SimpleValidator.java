/*
 * @(#)SimpleValidator.java	1.6, 03/12/19
 *
...
public final class SimpleValidator extends Validator {
    ...
    private void checkNetscapeCertType(X509Certificate cert, Set critSet) 
	    throws CertificateException {
    ...
    private void checkBasicConstraints(X509Certificate cert, Set critSet,
            int index) throws CertificateException {
	...
	// if a trusted certificate is found, append it and return
        ...
        if (subject.equals(issuer) == false) {
            List list = (List)trustedX500Principals.get(issuer);
            if (list != null) {
