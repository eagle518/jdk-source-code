/*
 * @(#)AdjacencyList.java	1.5 03/12/19
 *
 ...
 * </ul>
 * <p>
 * The iterator method returns objects of type <code>BuildStep</build>, not
...
public class AdjacencyList
{
     ...
     * at the start.
     */
    private boolean buildList(List theList, int index, BuildStep follow) {
            ...
            if (allNegOne) {
                ...
                if (allXcps) {
                    ...
                    if (possibles.size() == 1) {
                        ...
                        mStepList.add(new BuildStep((Vertex)(possibles.get(0)),
                                                    BuildStep.SUCCEED));
                    } else {
    ...
    public String toString() {
        ...
        for (int i = 0; i < mOrigList.size(); i++) {
            out = out + "LinkedList[" + i + "]:\n";

            List l = (List)mOrigList.get(i);
            Iterator it = l.iterator();

            while (it.hasNext()) {
                try {
                    Vertex step = (Vertex)(it.next());
