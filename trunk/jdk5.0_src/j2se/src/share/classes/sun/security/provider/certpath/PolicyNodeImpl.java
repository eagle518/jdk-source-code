...
final class PolicyNodeImpl implements PolicyNode {
    ...
    // the 4 fields specified by son-of-2459
     ...
     */
    PolicyNodeImpl(PolicyNodeImpl parent, String validPolicy, Set qualifierSet,
                   boolean criticalityIndicator, Set expectedPolicySet,
     ...
     */
    Set getPolicyNodesExpected(int depth, String expectedOID, boolean matchAny) 
    {
    ...
    private Set getPolicyNodesExpectedHelper(int depth, String expectedOID, 
	boolean matchAny) 
    {
     ...
     * @return a Set of matched <code>PolicyNode</code>s
     */
    Set getPolicyNodesValid(int depth, String validOID) {
        HashSet set = new HashSet();
    ...
    String asString() {
	    ...
	    sb.append("  EP: ");
	    for (Iterator t = getExpectedPolicies().iterator(); t.hasNext(); ) {
