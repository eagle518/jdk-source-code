/*
 * @(#)SeedGenerator.java	1.28 03/12/19
 *
...
abstract class SeedGenerator {
    ...
    final static String URL_DEV_RANDOM = Sun.URL_DEV_RANDOM;
    final static String URL_DEV_URANDOM = Sun.URL_DEV_URANDOM;

    // Static initializer to hook in selected or best performing generator
    static {
	String egdSource = Sun.getSeedSource();
