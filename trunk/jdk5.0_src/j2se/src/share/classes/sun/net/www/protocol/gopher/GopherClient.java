/*
 * @(#)GopherClient.java	1.20 04/05/18
 *
...
public class GopherClient extends NetworkClient implements Runnable {
	...
	useGopherProxy = tmp.booleanValue();

	gopherProxyHost = (String) java.security.AccessController.doPrivileged(
                new sun.security.action.GetPropertyAction("gopherProxyHost"));

	gopherProxyPort=((Integer)java.security.AccessController.doPrivileged(
	        new sun.security.action.GetIntegerAction("gopherProxyPort",
							 80))).intValue();
    }
