...
/*
  private void updateNeedsRepaint() {
    ...
    */
    ...
    /**
     * Returns true if thumb is long enough to display it and
     * false otherwise
     * @see #getArrowAreaSize
     */
    private boolean paintThumb(int arrAreaH){
        return (barLength >= 2*arrAreaH+MIN_THUMB_H);
    }
