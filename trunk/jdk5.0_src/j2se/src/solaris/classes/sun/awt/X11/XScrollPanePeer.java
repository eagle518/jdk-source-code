/*
 * @(#)XScrollPanePeer.java	1.19 04/01/16
 *
...
class XScrollPanePeer extends XComponentPeer implements ScrollPanePeer, XScrollbarClient {
    ...
    public final static int     SCROLLBAR = 17;
    ...
    static {
        m_setValue = XToolkit.getMethod(ScrollPaneAdjustable.class, "setTypedValue", new Class[] {Integer.TYPE, Integer.TYPE});
    }
    ...
    void setAdjustableValue(ScrollPaneAdjustable adj, int value, int type) {
        try {
            m_setValue.invoke(adj, new Object[] {new Integer(value), new Integer(type)});
