/*
 * @(#)PLATFORM_API_WinOS_Ports.c	1.10 10/03/23
 *
...
**
**	Overview:
**	This provides platform specfic Port (aka mixer) functions for Windows.
**	This implementation does not interface with the HAE engine at all.
**      This interface is for Windows and uses the mixer API to query and set ports
**
**	History	-
**	2002-07-30	$$fb created
*/
/*****************************************************************************/

// TODO: add support for MIXER/MUX controls on all lines
