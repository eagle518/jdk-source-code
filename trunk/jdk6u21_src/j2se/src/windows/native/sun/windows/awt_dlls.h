...
typedef BOOL (WINAPI *SetLayeredWindowAttributesType)(HWND, COLORREF, BYTE, DWORD);
typedef BOOL (WINAPI *UpdateLayeredWindowType)(HWND hwnd, HDC hdcDst, POINT *pptDst, SIZE *psize, 
...
extern SetLayeredWindowAttributesType fn_set_layered_window_attributes;
extern UpdateLayeredWindowType fn_update_layered_window;
...
// Dynamically load in DWMAPI.DLL and define the procedure pointers listed below.
extern void load_dwmapi_procs();

// Procedure pointers obtained from DWMAPI.DLL
// You must call load_dwmapi_procs() before using any of these.
...
extern DwmIsCompositionEnabledType fn_dwm_is_composition_enabled;
extern DwmGetWindowAttributeType fn_dwm_get_window_attribute;
