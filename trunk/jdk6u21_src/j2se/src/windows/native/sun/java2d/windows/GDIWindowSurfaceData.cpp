/*
 * @(#)GDIWindowSurfaceData.cpp	1.110 10/03/23
 *
...
static void GetCursorRect(HWND hW, RECT& rRect) {
    ...
    J2dTraceLn(J2D_TRACE_INFO, "GDIWinSD::GetCursorRect");
...
static BOOL GDIWinSD_CheckCursorArea(GDIWinSDOps *wsdo,
				    SurfaceDataBounds *bounds)
{
    AwtToolkit& tk = AwtToolkit::GetInstance();

    J2dTraceLn(J2D_TRACE_INFO, "GDIWinSD_CheckCursorArea");
