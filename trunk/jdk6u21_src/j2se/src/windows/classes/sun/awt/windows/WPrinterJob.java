/*
 * @(#)WPrinterJob.java	1.83 10/03/23
 *
...
/* Instance Variables */
     ...
     * set.
     * The fontCache facilitates re-use of the device size fonts
     * created. It's a Hashtable as access to that is synchronized.
     * The fonts in this table, which include one in each key as well
     * as the value, cannot be cleaned up until the job terminates.
     * To keep this in check the caller makes sure the table doesn't
     * explode in value.
     */
    private Font mLastFont;
    private int mLastRotation;
    private float mLastAwScale;
    Hashtable<FontKey1,Font> fontCache1 = new Hashtable<FontKey1,Font>();
    Hashtable<FontKey2,Font> fontCache2 = new Hashtable<FontKey2,Font>();
