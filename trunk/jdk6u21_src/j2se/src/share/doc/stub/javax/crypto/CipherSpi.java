...
public abstract class CipherSpi
{
     ...
     * algorithm parameters and <code>params</code> is null.
     */
    protected abstract void engineInit(int opmode, Key key, AlgorithmParameters
     ...
     * new block.
     */
    protected abstract byte[] engineUpdate(byte[] input, int inputOffset, int
        inputLen);
     ...
     * to hold the result
     */
    protected abstract int engineUpdate(byte[] input, int inputOffset, int
        inputLen, byte[] output, int outputOffset) throws ShortBufferException;
     ...
     */
    protected abstract byte[] engineDoFinal(byte[] input, int inputOffset, int
        inputLen) throws IllegalBlockSizeException, BadPaddingException;
     ...
     * bounded by the appropriate padding bytes
     */
    protected abstract int engineDoFinal(byte[] input, int inputOffset, int
        inputLen, byte[] output, int outputOffset)
