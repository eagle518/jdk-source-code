...
public class AVA implements DerEncoder {
	...
	this(in, format, (Map<String, String>) Collections.EMPTY_MAP);
    }
	...
	return toKeywordValueString
	    (toKeyword(DEFAULT, (Map<String, String>) Collections.EMPTY_MAP));
    }
	...
	return toRFC1779String((Map<String, String>) Collections.EMPTY_MAP);
    }
	...
	return toRFC2253String((Map<String, String>) Collections.EMPTY_MAP);
    }
	...
	typeAndValue.append
	    (toKeyword(RFC2253, (Map<String, String>) Collections.EMPTY_MAP));
	typeAndValue.append('=');
...
class AVAKeyword {
    ...
    static ObjectIdentifier getOID(String keyword, int standard) 
	    throws IOException {
	return getOID
	    (keyword, standard, (Map<String, String>) Collections.EMPTY_MAP);
    }
	...
	return getKeyword
	    (oid, standard, (Map<String, String>) Collections.EMPTY_MAP);
    }
