...
public class RDN {
	...
	this(name, format, (Map<String, String>) Collections.EMPTY_MAP);
    }
	...
	return toRFC2253StringInternal
	    (false, (Map<String, String>) Collections.EMPTY_MAP);
    }
	...
	if (c == null) {
		...
		(true, (Map<String, String>) Collections.EMPTY_MAP);
	    canonicalString = c;
	}
	return c;
    }
