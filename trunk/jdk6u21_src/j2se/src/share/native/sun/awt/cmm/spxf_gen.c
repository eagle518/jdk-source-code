...
/* get the responce data */
		...
		if (SpStatSuccess != Status)
			return Status;
                ...
                if (rTRC.TagType != Sp_AT_Curve &&
                    rTRC.TagType != Sp_AT_ParametricCurve)
                {
                    SpTagFree(&rTRC);
		...
		if (SpStatSuccess != Status) {
			...
			return Status;
                ...
                if (gTRC.TagType != Sp_AT_Curve &&
                    gTRC.TagType != Sp_AT_ParametricCurve)
                {
                    SpTagFree(&rTRC);
                    SpTagFree(&gTRC);
                    return SpStatBadTagType;
		...
		if (SpStatSuccess != Status) {
			...
			return Status;
                ...
                if (bTRC.TagType != Sp_AT_Curve &&
                    bTRC.TagType != Sp_AT_ParametricCurve)
                {
                    SpTagFree (&rTRC);
                    SpTagFree (&gTRC);
                    SpTagFree (&bTRC);
