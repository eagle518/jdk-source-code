...
\*****************************************************************************/
    ...
    Insets getInsets(XDecoratedPeer win, long window, long parent) {
        ...
        if (XWM.getInsetsFromProp(window, guessing)) {
            // array: left, right, top, bottom
            // constructor: top, left, bottom, right
            correctWM = new Insets(guessing[2], guessing[0], guessing[3], guessing[1]);
            insLog.log(Level.FINER, "Got insets from property: {0}", new Object[]{String.valueOf(guessing)});
        } else {
                ...
                switch (XWM.getWMID()) {
                  ...
                  case XWM.ENLIGHTEN_WM: {
                      ...
                      try {
                           ...
                           */
                          XWindowAttributes actualAttr = new XWindowAttributes();
                          try {
                  ...
                  case XWM.MOTIF_WM: {
                      ...
                      // WARNING: "The code below" was removed in delta 1.42
                      break;
                  }
                  case XWM.SAWFISH_WM: 
                  case XWM.OPENLOOK_WM: {
                  ...
                  default: {                /* this is very similar to the E! case above */
                          ...
                          && lwinAttr.get_height()+2*lwinAttr.get_border_width() == pattr.get_height())
                      {
                          ...
                          try {
                              ...
                              if (qt.get_parent() == lwinAttr.get_root()) {
