/*
 * @(#)WrapperGenerator.java	1.33 10/03/23
 *
    ...
    public void writeWrapper(String outputDir, StructType stp)
    {
        if (stp.getNumFields() > 0) {
		    ...
		    pw.println("\tprivate final boolean should_free_memory;");
                    ...
                    // The constructor of the wrapper SHOULD NOT be public.
                    // Because the files get generated only when the sun.awt.X11
                    // is being built, so these may be unavailable if used outside 
                    // of the package.
