/*
 * @(#)gtk2_interface.c	1.30 10/03/23
 *
...
#define GTK_TOGGLE_MENU_ITEM_SIZE 12
...
static gboolean     *vp_g_threads_got_initialized;
static void         (*fp_g_thread_init)(void* data);
...
static GtkWidget* (*fp_gtk_spin_button_new)(GtkAdjustment*, gdouble, guint);
 ...
 */
static void* dl_symbol(void* library, const char* name)
{
...
#define GTK_SYMBOL(symbol) (dl_symbol(gtk2_libhandle, symbol))
#define GTHREAD_SYMBOL(symbol) (dl_symbol(gthread_libhandle, symbol))
...
int gtk2_load()
{
    ...
    if (setjmp(j) == 0)
    {
        fp_gtk_check_version = GTK_SYMBOL("gtk_check_version");
        /* Check for GTK 2.2+ */
        ...
        /* GLib */
        fp_g_free = GTK_SYMBOL("g_free");
        fp_g_object_unref = GTK_SYMBOL("g_object_unref");

        fp_g_main_context_iteration =
            GTK_SYMBOL("g_main_context_iteration");

        fp_g_value_init = GTK_SYMBOL("g_value_init");
        fp_g_type_is_a = GTK_SYMBOL("g_type_is_a");

        fp_g_value_get_boolean = GTK_SYMBOL("g_value_get_boolean");
        fp_g_value_get_char = GTK_SYMBOL("g_value_get_char");
        fp_g_value_get_uchar = GTK_SYMBOL("g_value_get_uchar");
        fp_g_value_get_int = GTK_SYMBOL("g_value_get_int");
        fp_g_value_get_uint = GTK_SYMBOL("g_value_get_uint");
        fp_g_value_get_long = GTK_SYMBOL("g_value_get_long");
        fp_g_value_get_ulong = GTK_SYMBOL("g_value_get_ulong");
        fp_g_value_get_int64 = GTK_SYMBOL("g_value_get_int64");
        fp_g_value_get_uint64 = GTK_SYMBOL("g_value_get_uint64");
        fp_g_value_get_float = GTK_SYMBOL("g_value_get_float");
        fp_g_value_get_double = GTK_SYMBOL("g_value_get_double");
        fp_g_value_get_string = GTK_SYMBOL("g_value_get_string");
        fp_g_value_get_enum = GTK_SYMBOL("g_value_get_enum");
        fp_g_value_get_flags = GTK_SYMBOL("g_value_get_flags");
        fp_g_value_get_param = GTK_SYMBOL("g_value_get_param");
        fp_g_value_get_boxed = GTK_SYMBOL("g_value_get_boxed");
        fp_g_value_get_pointer = GTK_SYMBOL("g_value_get_pointer");
        fp_g_value_get_object = GTK_SYMBOL("g_value_get_object");
        fp_g_param_spec_int = GTK_SYMBOL("g_param_spec_int");
        fp_g_object_get = GTK_SYMBOL("g_object_get");
        fp_g_object_set = GTK_SYMBOL("g_object_set");

        vp_g_threads_got_initialized = GTK_SYMBOL("g_threads_got_initialized");
        fp_g_thread_init = GTHREAD_SYMBOL("g_thread_init");

        /* GDK */
        fp_gdk_pixmap_new = GTK_SYMBOL("gdk_pixmap_new");
        fp_gdk_pixbuf_get_from_drawable =
            GTK_SYMBOL("gdk_pixbuf_get_from_drawable");
        fp_gdk_gc_new = GTK_SYMBOL("gdk_gc_new");
        fp_gdk_rgb_gc_set_foreground = 
            GTK_SYMBOL("gdk_rgb_gc_set_foreground");
        fp_gdk_draw_rectangle = GTK_SYMBOL("gdk_draw_rectangle");
        fp_gdk_drawable_get_size = GTK_SYMBOL("gdk_drawable_get_size");
        fp_gdk_threads_init = GTK_SYMBOL("gdk_threads_init");
        fp_gdk_threads_enter = GTK_SYMBOL("gdk_threads_enter");
        fp_gdk_threads_leave = GTK_SYMBOL("gdk_threads_leave");

        /* Pixbuf */
        fp_gdk_pixbuf_new = GTK_SYMBOL("gdk_pixbuf_new");
        fp_gdk_pixbuf_new_from_file =
                GTK_SYMBOL("gdk_pixbuf_new_from_file");
        fp_gdk_pixbuf_get_width = GTK_SYMBOL("gdk_pixbuf_get_width");
        fp_gdk_pixbuf_get_height = GTK_SYMBOL("gdk_pixbuf_get_height");
        fp_gdk_pixbuf_get_pixels = GTK_SYMBOL("gdk_pixbuf_get_pixels");
        fp_gdk_pixbuf_get_rowstride =
                GTK_SYMBOL("gdk_pixbuf_get_rowstride");
        fp_gdk_pixbuf_get_has_alpha =
                GTK_SYMBOL("gdk_pixbuf_get_has_alpha");
        fp_gdk_pixbuf_get_bits_per_sample =
                GTK_SYMBOL("gdk_pixbuf_get_bits_per_sample");
        fp_gdk_pixbuf_get_n_channels =
                GTK_SYMBOL("gdk_pixbuf_get_n_channels");

        /* GTK painting */
        fp_gtk_init_check = GTK_SYMBOL("gtk_init_check");
        fp_gtk_paint_hline = GTK_SYMBOL("gtk_paint_hline");
        fp_gtk_paint_vline = GTK_SYMBOL("gtk_paint_vline");
        fp_gtk_paint_shadow = GTK_SYMBOL("gtk_paint_shadow");
        fp_gtk_paint_arrow = GTK_SYMBOL("gtk_paint_arrow");
        fp_gtk_paint_diamond = GTK_SYMBOL("gtk_paint_diamond");
        fp_gtk_paint_box = GTK_SYMBOL("gtk_paint_box");
        fp_gtk_paint_flat_box = GTK_SYMBOL("gtk_paint_flat_box");
        fp_gtk_paint_check = GTK_SYMBOL("gtk_paint_check");
        fp_gtk_paint_option = GTK_SYMBOL("gtk_paint_option");
        fp_gtk_paint_box_gap = GTK_SYMBOL("gtk_paint_box_gap");
        fp_gtk_paint_extension = GTK_SYMBOL("gtk_paint_extension");
        fp_gtk_paint_focus = GTK_SYMBOL("gtk_paint_focus");
        fp_gtk_paint_slider = GTK_SYMBOL("gtk_paint_slider");
        fp_gtk_paint_handle = GTK_SYMBOL("gtk_paint_handle");
        fp_gtk_paint_expander = GTK_SYMBOL("gtk_paint_expander");
        fp_gtk_style_apply_default_background =
                GTK_SYMBOL("gtk_style_apply_default_background");

        /* GTK widgets */
        fp_gtk_arrow_new = GTK_SYMBOL("gtk_arrow_new");
        fp_gtk_button_new = GTK_SYMBOL("gtk_button_new");
        fp_gtk_spin_button_new = GTK_SYMBOL("gtk_spin_button_new");
        fp_gtk_check_button_new = GTK_SYMBOL("gtk_check_button_new");
        fp_gtk_check_menu_item_new =
                GTK_SYMBOL("gtk_check_menu_item_new");
        fp_gtk_color_selection_dialog_new =
                GTK_SYMBOL("gtk_color_selection_dialog_new");
        fp_gtk_entry_new = GTK_SYMBOL("gtk_entry_new");
        fp_gtk_fixed_new = GTK_SYMBOL("gtk_fixed_new");
        fp_gtk_handle_box_new = GTK_SYMBOL("gtk_handle_box_new");
        fp_gtk_image_new = GTK_SYMBOL("gtk_image_new");
        fp_gtk_hpaned_new = GTK_SYMBOL("gtk_hpaned_new");
        fp_gtk_vpaned_new = GTK_SYMBOL("gtk_vpaned_new");
        fp_gtk_hscale_new = GTK_SYMBOL("gtk_hscale_new");
        fp_gtk_vscale_new = GTK_SYMBOL("gtk_vscale_new");
        fp_gtk_hscrollbar_new = GTK_SYMBOL("gtk_hscrollbar_new");
        fp_gtk_vscrollbar_new = GTK_SYMBOL("gtk_vscrollbar_new");
        fp_gtk_hseparator_new = GTK_SYMBOL("gtk_hseparator_new");
        fp_gtk_vseparator_new = GTK_SYMBOL("gtk_vseparator_new");
        fp_gtk_label_new = GTK_SYMBOL("gtk_label_new");
        fp_gtk_menu_new = GTK_SYMBOL("gtk_menu_new");
        fp_gtk_menu_bar_new = GTK_SYMBOL("gtk_menu_bar_new");
        fp_gtk_menu_item_new = GTK_SYMBOL("gtk_menu_item_new");
        fp_gtk_menu_item_set_submenu =
                GTK_SYMBOL("gtk_menu_item_set_submenu");
        fp_gtk_notebook_new = GTK_SYMBOL("gtk_notebook_new");
        fp_gtk_progress_bar_new =
            GTK_SYMBOL("gtk_progress_bar_new");
        fp_gtk_radio_button_new =
            GTK_SYMBOL("gtk_radio_button_new");
        fp_gtk_radio_menu_item_new =
            GTK_SYMBOL("gtk_radio_menu_item_new");
        fp_gtk_scrolled_window_new =
            GTK_SYMBOL("gtk_scrolled_window_new");
        fp_gtk_separator_menu_item_new =
            GTK_SYMBOL("gtk_separator_menu_item_new");
        fp_gtk_text_view_new = GTK_SYMBOL("gtk_text_view_new");
        fp_gtk_toggle_button_new =
            GTK_SYMBOL("gtk_toggle_button_new");
        fp_gtk_toolbar_new = GTK_SYMBOL("gtk_toolbar_new");
        fp_gtk_tree_view_new = GTK_SYMBOL("gtk_tree_view_new");
        fp_gtk_viewport_new = GTK_SYMBOL("gtk_viewport_new");
        fp_gtk_window_new = GTK_SYMBOL("gtk_window_new");
        fp_gtk_dialog_new = GTK_SYMBOL("gtk_dialog_new");
        fp_gtk_spin_button_new = GTK_SYMBOL("gtk_spin_button_new");

        fp_gtk_adjustment_new = GTK_SYMBOL("gtk_adjustment_new");
        fp_gtk_container_add = GTK_SYMBOL("gtk_container_add");
        fp_gtk_menu_shell_append =
            GTK_SYMBOL("gtk_menu_shell_append");
        fp_gtk_widget_realize = GTK_SYMBOL("gtk_widget_realize");
        fp_gtk_widget_destroy = GTK_SYMBOL("gtk_widget_destroy");
        fp_gtk_widget_render_icon =
            GTK_SYMBOL("gtk_widget_render_icon");
        fp_gtk_widget_set_name = 
            GTK_SYMBOL("gtk_widget_set_name");
        fp_gtk_widget_set_parent =
            GTK_SYMBOL("gtk_widget_set_parent");
        fp_gtk_widget_set_direction = 
            GTK_SYMBOL("gtk_widget_set_direction");
        fp_gtk_widget_style_get =
            GTK_SYMBOL("gtk_widget_style_get");
        fp_gtk_widget_class_install_style_property =
            GTK_SYMBOL("gtk_widget_class_install_style_property");
        fp_gtk_widget_class_find_style_property =
            GTK_SYMBOL("gtk_widget_class_find_style_property");
        fp_gtk_widget_style_get_property =
            GTK_SYMBOL("gtk_widget_style_get_property");
        fp_pango_font_description_to_string =
            GTK_SYMBOL("pango_font_description_to_string");
        fp_gtk_settings_get_default =
            GTK_SYMBOL("gtk_settings_get_default");
        fp_gtk_widget_get_settings =
            GTK_SYMBOL("gtk_widget_get_settings");
        fp_gtk_border_get_type =  GTK_SYMBOL("gtk_border_get_type");
        fp_gtk_arrow_set = GTK_SYMBOL("gtk_arrow_set");
        fp_gtk_widget_size_request =
            GTK_SYMBOL("gtk_widget_size_request");
    ...
    /*
     * Init thread synchonization subsystem.
     */
    if (!*vp_g_threads_got_initialized) 
...
static void init_toggle_widget(WidgetType widget_type, gint synth_state)
{
    ...
    if (widget_type == RADIO_BUTTON || widget_type == CHECK_BOX) {
...
/*        case COLOR_CHOOSER:
        ...
        case COMBO_BOX_TEXT_FIELD:
            ...
            {
                gtk2_widgets[_GTK_COMBO_BOX_TEXT_FIELD_TYPE] =
                     (*fp_gtk_entry_new)();
            }
        ...
        case POPUP_MENU_SEPARATOR:
            ...
            break;
        case PROGRESS_BAR:
            if (init_result = (NULL == gtk2_widgets[_GTK_PROGRESS_BAR_TYPE]))
            {
                gtk2_widgets[_GTK_PROGRESS_BAR_TYPE] =
                    (*fp_gtk_progress_bar_new)();
            }
            result = gtk2_widgets[_GTK_PROGRESS_BAR_TYPE];
            break;
        case RADIO_BUTTON:
                 ...
                 widget_type != OPTION_PANE)
        {
                ...
                widget_type == RADIO_BUTTON_MENU_ITEM )
            {
                GParamSpec* param = (*fp_gtk_widget_class_find_style_property)(
                                     ((GTypeInstance*)gtk2_widget)->g_class,
                                     "indicator_size" );
                if( !param )
                {
                    param = (*fp_g_param_spec_int)("indicator_size", NULL, NULL, 0,
                                INT_MAX, 12, G_PARAM_READABLE);
                    (*fp_gtk_widget_class_install_style_property)(
                                ((GTypeInstance*)gtk2_widget)->g_class, param);
                }
            }
        ...
        const gchar *detail, gint x, gint y, gint width, gint height)
{
    ...
    if((*fp_gtk_widget_class_find_style_property)(
       ((GTypeInstance*)gtk2_widget)->g_class, "indicator_size")) {
        (*fp_gtk_widget_style_get)(gtk2_widget, "indicator_size", &size, NULL);
    } else {
        // indicator_size property may not be available pre-GTK  2.4, so fall
        // back on hardcoded size in this case
        size = GTK_TOGGLE_MENU_ITEM_SIZE;
    }

    if (widget_type == CHECK_BOX) {
        (*fp_gtk_widget_style_get)(gtk2_widget, "indicator_spacing",
                                   &offset, NULL);
    }
...
/***********************************************/
jobject create_Dimension(JNIEnv *env, jint width, jint height)
{
    static jmethodID cid = NULL;
    jvalue values[2];
    ...
    return create_Object(env, &cid, "java/awt/Dimension", "(II)V", values);
}

/* Returns java.awt.Dimension object containig *
 * size of a backgroung image for the given    *
 * widget and state.                           */
jobject gtk2_get_image_dimension(JNIEnv *env, WidgetType widget_type, GtkStateType state_type)
{
    init_containers();
    ...
    if (style->bg_pixmap[state_type] != NULL )
    {
        gint width = 0, height = 0;
        (*fp_gdk_drawable_get_size)(style->bg_pixmap[state_type], &width, &height);
        return create_Dimension(env, width, height);
    }
...
/***********************************************
 * Fills BufferImage with appropriate image    */
                       ...
                       WidgetType widget_type, GtkStateType state_type)
{
    ...
    if (style->bg_pixmap[state_type] != NULL )
    {
        GdkPixbuf *pixbuf = (*fp_gdk_pixbuf_new)(GDK_COLORSPACE_RGB, TRUE, 8,
                                                 width, height);
        (*fp_gdk_pixbuf_get_from_drawable)(pixbuf, style->bg_pixmap[state_type],
                                           NULL, 0, 0, 0, 0, width, height);

        guchar* pixels = (*fp_gdk_pixbuf_get_pixels)(pixbuf);
