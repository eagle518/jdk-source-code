...
//=============================================================================
  ...
  private:
    ...
    Label                _bound_label; // Stable copy of already-bound label
...
public:
  ...
  CodeSection* current_section() const { return _current_section; }
  void     set_current_section(CodeSection* cs);
...
#ifdef ASSERT
  bool needs_flush_bundle() const;  // for asserts
#endif //ASSERT
