/*
 * @(#)MNetscape6CookieHandler.java	1.13 10/03/24
 *
...
public final class MNetscape6CookieHandler implements CookieHandler 
{
	...
	sun.plugin.navig.motif.Worker.setCookieForURL(url.toString(), value);
    }
	...
	return sun.plugin.navig.motif.Worker.findCookieForURL(url.toString());
    }
}
