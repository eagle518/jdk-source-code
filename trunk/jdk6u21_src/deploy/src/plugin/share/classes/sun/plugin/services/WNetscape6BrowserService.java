/*
 * @(#)WNetscape6BrowserService.java	1.43 10/03/24
 *
...
/** 
 * WNetscape6BrowserService is a class that encapsulates the browser service
 * in Netscape 6 on Win32.
 */
public final class WNetscape6BrowserService extends WPlatformService implements BrowserService
{
    /**
    ...
    {
	return new sun.plugin.net.cookie.WNetscape6CookieHandler();
    }
    ...
    {
	return new com.sun.deploy.net.proxy.WNetscape6ProxyConfig();
    }
    /**
    ...
    {
	return new sun.plugin.net.proxy.WNetscape6BrowserProxyHandler();
    }
    ...
    {
	return new sun.plugin.viewer.context.WNetscape6AppletContext();
    }
	...
	pbc.setPluginAppletContext(new sun.plugin.viewer.context.WNetscape6AppletContext());
