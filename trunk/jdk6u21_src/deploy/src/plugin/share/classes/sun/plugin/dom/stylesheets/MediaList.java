...
public final class MediaList implements org.w3c.dom.stylesheets.MediaList  {
     ...
     */
    public MediaList(DOMObject obj, Document doc) {
	this.obj = obj;
	this.doc = doc;
    }
    ...
    public String getMediaText() {
    	return DOMObjectHelper.getStringMemberNoEx(obj, SSLConstants.ATTR_MEDIA_TEXT);	
    }

    public void setMediaText(String mediaText)
                             throws DOMException
    {
	DOMObjectHelper.setStringMember(obj, SSLConstants.ATTR_MEDIA_TEXT, mediaText);
    }
    ...
    public void deleteMedium(String oldMedium)
                             throws DOMException {
	DOMObjectHelper.callStringMethod(obj, SSLConstants.FUNC_DELETE_MEDIUM, new Object[]{oldMedium});
    }
    ...
    public void appendMedium(String newMedium)
                             throws DOMException {
	DOMObjectHelper.callStringMethod(obj, SSLConstants.FUNC_APPEND_MEDIUM, new Object[]{newMedium} );
    }
}
